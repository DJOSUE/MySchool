    ...
    <div class="conty">
        ...
        <div class="content-i">
            <div class="content-box">
                ...
                <hr>
                <?= form_open(base_url() . 'reports/academic_students_achievement/', array('class' => 'form m-b'));?>
                <div class="row">
                    <div class="col-sm-2">
                        ...
                        <table cellpading="0" cellspacing="0" border="1"
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        <?=$this->academic->get_student_approved($year_id, $semester['semester_id'],0,79);?>
                                    </td>
                                    <td>
                                        <?=$this->academic->get_student_approved($year_id, $semester['semester_id'],80,84);?>
                                    </td>
                                    <td>
                                        <?=$this->academic->get_student_approved($year_id, $semester['semester_id'],85,89);?>
                                    </td>
                                    <td>
