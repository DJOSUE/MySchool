                                                ...
                                                <div class="row" style="justify-content: flex-end;">
                                                    ...
                                                    <div class="form-buttons">
                                                        <button class="btn btn-rounded btn-primary"
                                                            onclick="showAjaxModal('<?php echo base_url();?>modal/popup_helpdesk/modal_ticket_add_message/<?= $ticket_code;?>');">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="row-actions">
                                                                        <a href="javascript:void(0);" class="grey"
                                                                            ...
                                                                            data-original-title="<?= getPhrase('view');?>"
                                                                            onclick="showAjaxModal('<?= base_url();?>modal/popup_helpdesk/modal_ticket_view_message/<?=$item['ticket_message_id'];?>');">
                                                                            <i
                                                                                class="os-icon picons-thin-icon-thin-0043_eye_visibility_show_visible"></i>
                                                                        </a>
