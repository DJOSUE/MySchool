            ...
            <div class="mCustomScrollbar" data-mcs-theme="dark">
                <ul class="left-menu">
                    ...
                    <li <?php if($page_name == 'panel'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>teacher/panel/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('dashboard');?>">
                    ...
                    <li <?php if($page_name == 'message' || $page_name == 'group'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>teacher/message/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('messages');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'teachers'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>teacher/teacher_list/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('teachers');?>">
                            <div class="left-menu-icon">        
                    ...
                    <li <?php if($page_name == 'students_area' || $page_name == 'view_marks' || $page_name == 'subject_marks'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>teacher/students_area/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('students');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'single_homework' || $page_name == 'forum' || $page_name == 'meet' || $page_name == 'study_material' || $page_name == 'upload_marks' || $page_name == 'edit_forum' || $page_name == 'forum_room' || $page_name == 'grados' || $page_name == 'homework_details' || $page_name == 'homework_edit' || $page_name == 'homework_room' || $page_name == 'homework' || $page_name == 'cursos' || $page_name == 'exam_edit' || $page_name == 'subject_dashboard' || $page_name == 'online_exams' || $page_name == 'exam_room' || $page_name == 'exam_results'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>teacher/grados/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('academic');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'student_report' || $page_name == 'view_report'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>teacher/student_report/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('behavior');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'news'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>teacher/news/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('news');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'request'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>teacher/request/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('permissions');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'calendar'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>teacher/calendar/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('calendar');?>">
                            <div class="left-menu-icon">
                ...
                <ul class="left-menu">
                    ...
                    <li>
                        <a href="<?php echo base_url();?>teacher/students_area/">
                            ...
                            <span class="left-menu-title"><?php echo getPhrase('students');?></span>
                        </a>
                    </li>
                    <li>
