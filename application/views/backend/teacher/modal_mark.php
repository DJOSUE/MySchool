...
?>    
    <div class="modal-body">
        <div class="modal-header" style="background-color:#00579c">
            <h6 class="title" style="color:white"><?php echo getPhrase('update_activities');?></h6>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group label-floating">
                            <label class="control-label"><?php echo getPhrase('activity');?> 1</label>
                            <input class="form-control" type="text" value="<?php echo $row['la1'];?>" name="la1">
                        </div>
                    </div>
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group label-floating">
                            <label class="control-label"><?php echo getPhrase('activity');?> 2</label>
                            <input class="form-control" type="text" value="<?php echo $row['la2'];?>" name="la2">
                        </div>
                    </div>
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group label-floating">
                            <label class="control-label"><?php echo getPhrase('activity');?> 3</label>
                            <input class="form-control" type="text" value="<?php echo $row['la3'];?>" name="la3">
                        </div>
                    </div>
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group label-floating">
                            <label class="control-label"><?php echo getPhrase('activity');?> 4</label>
                            <input class="form-control" type="text" value="<?php echo $row['la4'];?>" name="la4">
                        </div>
                    </div>
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group label-floating">
                            <label class="control-label"><?php echo getPhrase('activity');?> 5</label>
                            <input class="form-control" type="text" value="<?php echo $row['la5'];?>" name="la5">
                        </div>
                    </div>
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group label-floating">
                            <label class="control-label"><?php echo getPhrase('activity');?> 6</label>
                            <input class="form-control" type="text" value="<?php echo $row['la6'];?>" name="la6">
                        </div>
                    </div>
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group label-floating">
                            <label class="control-label"><?php echo getPhrase('activity');?> 7</label>
                            <input class="form-control" type="text" value="<?php echo $row['la7'];?>" name="la7">
                        </div>
                    </div>
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group label-floating">
                            <label class="control-label"><?php echo getPhrase('activity');?> 8</label>
                            <input class="form-control" type="text" value="<?php echo $row['la8'];?>" name="la8">
                        </div>
                    </div>
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group label-floating">
                            <label class="control-label"><?php echo getPhrase('activity');?> 9</label>
                            <input class="form-control" type="text" value="<?php echo $row['la9'];?>" name="la9">
                        </div>
                    </div>
                    <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="form-group label-floating">
                            <label class="control-label"><?php echo getPhrase('activity');?> 10</label>
