<?php
	...
	$exam_name  		= 	$this->db->get_where('units' , array('unit_id' => $exam_id))->row()->name;
                            ...
                            <div class="infos">
                                ...
                                <div class="info-2">
                                    ...
                                    <div class="company-address">
                                        <?php echo getPhrase('roll');?>: <?php echo $this->db->get_where('enroll', array('student_id' => $student_id))->row()->roll;?><br/><?php echo $this->db->get_where('class', array('class_id' => $class_id))->row()->name;?><br/><?php echo $this->db->get_where('section' , array('class_id' => $section_id))->row()->name;?>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table class="table">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $this->db->get_where('mark' , array('subject_id' => $row3['subject_id'], 'unit_id' => $exam_id, 'student_id'=> $student_id,'year' => $running_year))->row()->labtotal; ?></td>
                                        </tr>
