                                    ...
                                    <div class="friend-item-content">
                                        <div class="more">
                                            ...
                                            <ul class="more-dropdown">
                                                <li>
                                                    <a href="<?php echo base_url();?>teacher/cursos/<?php echo base64_encode($cl['class_id']);?>/"><?php echo getPhrase('my_subjects');?></a>
                                                </li>
                                            </ul>
                                        </div>
                                        <div class="friend-avatar">
                                            ...
                                            <div class="author-content">
                                                <a href="<?php echo base_url();?>teacher/cursos/<?php echo base64_encode($cl['class_id']);?>/"
                                                    class="h5 author-name"><?php echo $this->db->get_where('class', array('class_id' => $cl['class_id']))->row()->name;?></a>
