	        ...
	        <div class="os-tabs-w menu-shad">
		        <div class="os-tabs-controls">
		            <ul class="navs navs-tabs upper">
			            ...
			            <li class="navs-item">
			                <a class="navs-links active" href="<?php echo base_url();?>teacher/homework_edit/<?php echo $homework_code;?>/"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new"></i><span><?php echo getPhrase('edit');?></span></a>
			            </li>
		            </ul>
		        </div>
	        </div>
	                ...
	                <div class="row">	
	                    <div class="col-sm-8">
		                    <div class="pipeline white lined-primary">
		                        <div class="pipeline-header">
			                        <h5 class="pipeline-name"><?php echo getPhrase('update_homework');?></h5>
		                        </div>
			                    <?php echo form_open(base_url() . 'teacher/homework/update/' . $homework_code, array('enctype' => 'multipart/form-data')); ?>
			                        <div class="form-group">
				                        <label for=""> <?php echo getPhrase('title');?></label><input class="form-control" required="" name="title" value="<?php echo $row['title'];?>" type="text">
			                        </div>
			                        <div class="form-group">
				                        <label> <?php echo getPhrase('description');?></label><textarea cols="80" id="ckeditor1" name="description" required rows="2"><?php echo $row['description'];?></textarea>
				                    </div>
				                    <div class="form-group">
				                        <label for=""> <?php echo getPhrase('delivery_date');?></label>
				                    ...
				                    <div class="form-group">
                        				<label for=""> <?php echo getPhrase('limit_hour');?></label>
                                    ...
                                    <div class="row">
                                        <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
            		                        <center><label class="control-label"><?php echo getPhrase('type');?></label></center>
            		                    </div>
            		                    <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
            		                        <div class="custom-control custom-radio" style="float: right">
                                                <input  type="radio" <?php if($row['type'] == 1) echo 'checked';?> name="type" id="1" value="1" class="custom-control-input"> <label for="1" class="custom-control-label"><?php echo getPhrase('online_text');?></label>
                                            </div>
                                        </div>
                                        <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
                                            <div class="custom-control custom-radio">
                                                <input  type="radio" <?php if($row['type'] == 2) echo 'checked';?> name="type" id="2" value="2" class="custom-control-input"> <label for="2" class="custom-control-label"><?php echo getPhrase('files');?></label>
                                            </div>
                            		    </div>
            		                </div>
	                    ...
	                    <div class="col-sm-4">
		                    ...
		                    <div class="pipeline white lined-warning">
		                        <div class="pipeline-header"><h5 class="pipeline-name"><?php echo getPhrase('students');?></h5></div>
