            ...
            <div class="os-tabs-w menu-shad">
		        <div class="os-tabs-controls">
		            <ul class="navs navs-tabs upper">
			            <li class="navs-item">
			                <a class="navs-links active" href="<?php echo base_url();?>teacher/homeworkroom/<?php echo $homework_code;?>/"><i class="os-icon picons-thin-icon-thin-0014_notebook_paper_todo"></i><span><?php echo getPhrase('homework_details');?></span></a>
			            </li>
			            <li class="navs-item">
			                <a class="navs-links" href="<?php echo base_url();?>teacher/homework_details/<?php echo $homework_code;?>/"><i class="os-icon picons-thin-icon-thin-0100_to_do_list_reminder_done"></i><span><?php echo getPhrase('deliveries');?></span></a>
			            </li>
			            <li class="navs-item">
                                    ...
                                    <article class="hentry post thumb-full-width">                
                                        <div class="post__author author vcard inline-items">
                                            ...
                                            <div class="author-date">
                                                ...
                                                <div class="post__date">
                                                    ...
                                                    <?php if($row['status'] == 1):?>
                                                        <span class="text-success"><?php echo getPhrase('published');?></span>
                                                    <?php else:?>
                                                        <span class="text-danger"><?php echo getPhrase('no_published');?></span>
                                                    <?php endif;?>
                                                    </time>
                                                </div>
                                            </div>                
                                            <div class="more">
                                                ...
                                                <ul class="more-dropdown">
                                                    <li><a href="<?php echo base_url();?>teacher/homework_edit/<?php echo $row['homework_code'];?>/"><?php echo getPhrase('edit');?></a></li>
                                                    <li><a href="<?php echo base_url();?>teacher/homework_details/<?php echo $row['homework_code'];?>/"><?php echo getPhrase('deliveries');?></a></li>
                                                </ul>
                                            </div>                
                                        </div>                
                                        <div class="edu-posts cta-with-media verde">
                                            <div class="cta-content">
                                                ...
                                                <?php endif;?>
                                                <div class="deadtime">
                                                    <span><?php echo getPhrase('date');?>:</span><i class="picons-thin-icon-thin-0027_stopwatch_timer_running_time"></i><?php echo $row['date_end'];?> @ <?php echo $row['time_end'];?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="control-block-button post-control-button">
                                            <a href="#" class="btn btn-control featured-post" style="background-color: #99bf2d; color: #fff;" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getPhrase('homework');?>">
                                        ...
                                        <div class="post-additional-info inline-items">
                                            ...
                                            <div class="names-people-likes">
                                                <?php if(count($checkData) > 5):?>
                                                    <?php echo getPhrase('and');?> <?php echo count($checkData)-5;?> <?php echo getPhrase('other_people_viewed_this_post');?>.
                                            <?php else:?>
                                        ...
                                        <ul class="widget w-friend-pages-added notification-list friend-requests">
                                            ...
                                            <li class="inline-items">
                                                ...
                                                <div class="notification-event">
                                                    ...
                                                    <span class="chat-message-item"><?php echo getPhrase('roll');?>: <?php echo $this->db->get_where('enroll' , array('student_id' => $row2['student_id']))->row()->roll; ?></span>
                                                </div>
                                            </li>
                                        <?php endforeach;?>
                                        </ul>
