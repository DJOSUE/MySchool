        ...
        <div class="os-tabs-w menu-shad">
            <div class="os-tabs-controls">
                <ul class="navs navs-tabs upper">
                    ...
                    <?php endif; ?>
                    <li class="navs-item">
                        <a class="navs-links active" href="<?php echo base_url();?>teacher/meet/<?php echo $data;?>/"><i
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center bolder">
                                                        ...
                                                        <a class="grey"
                                                            ...
                                                            href="<?php echo base_url();?>teacher/meet/delete/<?php echo $row['live_id']?>/<?php echo $data;?>"><i
