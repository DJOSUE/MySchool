            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        <li class="navs-item">
                            <a class="navs-links" href="<?php echo base_url();?>teacher/examroom/<?php echo $online_exam_id;?>/"><i class="os-icon picons-thin-icon-thin-0016_bookmarks_reading_book"></i><span><?php echo getPhrase('exam_details');?></span></a>
                        </li>
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>teacher/exam_results/<?php echo $online_exam_id;?>/"><i class="os-icon picons-thin-icon-thin-0100_to_do_list_reminder_done"></i><span><?php echo getPhrase('results');?></span></a>
                        </li>
                        <li class="navs-item">
                            <a class="navs-links" href="<?php echo base_url();?>teacher/exam_edit/<?php echo $online_exam_id;?>/"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new"></i><span><?php echo getPhrase('edit');?></span></a>
                        </li>
                    </ul>
                </div>
            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td><?php $query = $this->db->get_where('online_exam_result', array('online_exam_id' => $online_exam_id, 'student_id' => $row['student_id']));
                                                    if ($query->num_rows() > 0){
                                                        ...
                                                        echo "<span class='badge badge-danger'>".getPhrase('failed')."</span>";
                                                    }
                                                    ?>
                                                </td>
                                                <td><?php  if ($query->num_rows() > 0){?><a href="<?php echo base_url();?>teacher/online_exam_result/<?php echo $online_exam_id;?>/<?php echo $row['student_id'];?>/" class="btn btn-success btn-sm btn-rounded"><?php echo getPhrase('view_results');?></a><?php } else echo getPhrase('no_actions');?></td>
                                            </tr>
                                        <?php endforeach; ?>
                                        </tbody>
                                    </table>
                            ...
                            <div class="pipeline white lined-secondary">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-lightbor table-lightfont">
                                        <tr>
                                            <th><?php echo getPhrase('start_time');?>:</th>
                                            <td><?php echo $online_exam_details['time_start'];?></td>
                                        </tr>
                                        <tr>
                                            <th><?php echo getPhrase('end_time');?>: </th>
                                            <td><?php echo $online_exam_details['time_end'];?></td>
                                        </tr>
                                        <tr>
                                            <th><?php echo getPhrase('duration');?>: </th>
                                            <td><?php $minutes = number_format($online_exam_details['duration']/60,0); echo $minutes;?> <?php echo getPhrase('minutes');?>.</td>
                                        </tr>
                                        <tr>
                                            <th><?php echo getPhrase('average_required');?>:</th>
