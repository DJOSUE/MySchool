    ...
    <div class="page-title">
        <div class="fancy-selector-w">
            <div class="fancy-selector-current">
                <div class="fs-img">
                    <img alt=""
                        src="<?php echo base_url();?>public/uploads/subject_icon/<?php echo $this->db->get_where('subject', array('subject_id' => $fc_ex[2], 'year' => $running_year, 'semester_id' => $running_semester))->row()->icon;?>">
                </div>
                <div class="fs-main-info">
                    <div class="fs-name">
                        <?php echo $this->db->get_where('subject', array('subject_id' => $fc_ex[2], 'year' => $running_year, 'semester_id' => $running_semester))->row()->name;?> -
            ...
            <div class="fancy-selector-options">
                ...
                ?>
                <a
                    href="<?php echo base_url();?>teacher/subject_dashboard/<?php echo base64_encode($fc_ex[0].'-'.$fc_ex[1].'-'.$fancy_row2['subject_id']);?>/">
                    <div
                        ...
                        <div class="fs-main-info">
                            <div class="fs-name">
                                ...
                                (<?php echo $this->db->get_where('section', array('section_id' => $fancy_row2['section_id'], 'year' => $running_year, 'semester_id' => $running_semester))->row()->name;?>)
                            </div>
                        </div>
                    </div>
                </a>
        ...
        <div class="control-block">
                        ...
                        <ul class="notification-list chat-message">
                            ...
                            <li class="message-unread">
                                ...
                                <div class="notification-event">
                                    <a href="<?php echo base_url();?>teacher/message/message_read/<?php echo $fancy_rows['message_thread_code'];?>/"
            ...
            <div class="control-icon more has-items">
                ...
                <div class="more-dropdown more-with-triangle triangle-top-center">
                    ...
                    <a href="<?php echo base_url();?>teacher/notifications/"
            ...
            <div class="author-page author vcard inline-items more">
                <div class="author-thumb">
                    <img alt="author"
                        src="<?php echo $this->crud->get_image_url('teacher', $this->session->userdata('login_user_id'));?>"
                ...
                <a href="#" class="author-name fn">
                    <div class="author-title">
                        <?php echo $this->crud->get_name('teacher', $this->session->userdata('login_user_id'));?> 
            ...
            <div class="mCustomScrollbar" data-mcs-theme="dark">
                <ul class="notification-list chat-message">
                    ...
                    <li class="message-unread">
                        ...
                        <div class="notification-event">
                            <a href="<?php echo base_url();?>teacher/message/message_read/<?php echo $row1['message_thread_code'];?>/"
                                class="h6 notification-friend"><?php echo $this->crud->get_name($fancy_user_to_show_type, $fancy_user_to_show_id);?></a>
                            <span class="chat-message-item"
                                style="text-align: justify;"><?php if($rw->sender == $fancy_current_user) echo getPhrase('you').": ". substr($rw->message, 0, 90).'...'; else echo substr($rw->message, 0, 90);?>...</span>
                            <span class="notification-date"><time
