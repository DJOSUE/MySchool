        ...
        <div class="cursos cta-with-media" style="background: #<?php echo $row['color'];?>;">
            <div class="cta-content">
                ...
                <h3 class="cta-header"><?php echo $row['name'];?> -
                    <small><?php echo getPhrase('study_material');?></small></h3>
                <small
                            ...
                            <div class="element-wrapper">
                                <div class="element-box-tp">
                                    <h6 class="element-header">
                                        <?php echo getPhrase('study_material');?>
                                        <div style="margin-top:auto;float:right;"><a href="#" data-target="#addmaterial"
                                                data-toggle="modal"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-left cell-with-media ">
                                                        <a href="<?php echo base_url().'public/uploads/document/'.$row['file_name']; ?>"
                                                            style="color:gray;">
                                                            <?php if($row['file_type'] == 'PDF'):?>
                                                            <i class="picons-thin-icon-thin-0077_document_file_pdf_adobe_acrobat"
                                                                style="font-size:20px; color:gray;"></i>
                                                            <?php endif;?>
                                                            <?php if($row['file_type'] == 'Zip'):?>
                                                            <i class="picons-thin-icon-thin-0076_document_file_zip_archive_compressed_rar"
                                                                style="font-size:20px; color:gray;"></i>
                                                            <?php endif;?>
                                                            ...
                                                            <i class="picons-thin-icon-thin-0078_document_file_word_office_doc_text"
                                                                style="font-size:20px; color:gray;"></i>
                                                            <?php endif;?>
                                                            <?php if($row['file_type'] == 'Image'):?>
                                                            <i class="picons-thin-icon-thin-0082_image_photo_file"
                                                                style="font-size:20px; color:gray;"></i>
                                                            <?php endif;?>
                                                            <?php if($row['file_type'] == 'Other'):?>
                                                            <i class="picons-thin-icon-thin-0111_folder_files_documents"
                                                                style="font-size:20px; color:gray;"></i>
                                                            <?php endif;?><span><?php echo $row['file_name'];?></span><span
                                                    ...
                                                    <td class="text-center bolder">
                                                        ...
                                                        <a class="grey"
                                                            ...
                                                            href="<?php echo base_url();?>teacher/study_material/delete/<?php echo $row['document_id']?>/<?php echo $data;?>"><i
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="ui-block-title" style="background-color:#00579c">
                    <h6 class="title" style="color:white"><?php echo getPhrase('upload_study_material');?></h6>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="form-group label-floating is-select">
                                <label class="control-label"><?php echo getPhrase('file_type');?></label>
                                <div class="select">
                                    <select name="file_type" required="">
                                        ...
                                        <option value="Other"><?php echo getPhrase('other');?></option>
                                    </select>
                                </div>
                            </div>
                        </div>
