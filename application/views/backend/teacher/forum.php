                            ...
                            <div class="element-wrapper">
                                <div class="element-box-tp">
                                    <h6 class="element-header">
                                        ...
                                        <div style="margin-top:auto;float:right;"><a href="#" data-target="#new_post"
                                                data-toggle="modal"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="bolder">
                                                        <a class="grey" data-toggle="tooltip"
                                                            ...
                                                            href="<?php echo base_url();?>teacher/edit_forum/<?php echo $row['post_code'];?>"><i
                                                                class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i></a>
                                                        <a class="grey" data-toggle="tooltip"
                                                            data-placement="top"
                                                            data-original-title="<?php echo getPhrase('view_forum');?>"
                                                            href="<?php echo base_url();?>teacher/forumroom/<?php echo $row['post_code'];?>"><i
                                                        ...
                                                        <a class="grey" class="danger" data-toggle="tooltip"
                                                            ...
                                                            href="<?php echo base_url(); ?>teacher/forum/delete/<?php echo $row['post_code']; ?>/<?php echo $data;?>/"><i
