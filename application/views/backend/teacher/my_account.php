                        ...
                        <div class="eduappgt-sticky-sidebar">
                            <div class="sidebar__inner">
                                ...
                                <div class="ui-block paddingtel">
                                    ...
                                    <?php 
										$photo  = $this->crud->getUserSocial('teacher', 'fb_photo');
                                     	$name   = $this->crud->getUserSocial('teacher', 'fb_name');
                                    	$id     = $this->crud->getUserSocial('teacher', 'fb_id');
                                    	$gid    = $this->crud->getUserSocial('teacher', 'g_oauth');
                                    	$fname  = $this->crud->getUserSocial('teacher', 'g_fname');
                                    	$lname  = $this->crud->getUserSocial('teacher', 'g_lname');
                                    	$gphoto = $this->crud->getUserSocial('teacher', 'g_picture');
                                    	$gemail = $this->crud->getUserSocial('teacher', 'g_email');
									?>
