                            ...
                            <div class="element-wrapper">
                                <div class="element-box-tp">
                                    <h6 class="element-header">
                                        ...
                                        <div style="margin-top:auto;float:right;"><a href="#"
                                        ...
                                        <table class="table table-padded">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="bolder">
                                                        <a class="grey"
                                                            href="<?php echo base_url();?>teacher/homeworkroom/<?php echo $hm['homework_code'];?>"
                                                        ...
                                                        <a class="grey" data-toggle="tooltip"
                                                            ...
                                                            class="danger"
                                                            href="<?php echo base_url(); ?>teacher/homework/delete/<?php echo $hm['homework_code']; ?>/<?php echo $data;?>/"
                        ...
                        <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
                            <center>
                                <div class="custom-control custom-radio" style="float: right">
                                    <input type="radio" name="type" id="1" value="1" class="custom-control-input">
                                    <label for="1"
                        ...
                        <div class="col col-lg-6 col-md-6 col-sm-6 col-6">
                            <div class="custom-control custom-radio">
                                <input type="radio" name="type" id="2" value="2" class="custom-control-input"> <label
                                    for="2" class="custom-control-label"><?php echo getPhrase('file');?></label>
                            </div>
                        </div>
