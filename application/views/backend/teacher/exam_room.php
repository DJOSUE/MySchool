            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>teacher/examroom/<?php echo $online_exam_id;?>/"><i class="os-icon picons-thin-icon-thin-0016_bookmarks_reading_book"></i><span><?php echo getPhrase('exam_details');?></span></a>
                        </li>
                        <li class="navs-item">
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php 
                                                            if($added_question['type'] == "fill_in_the_blanks") {
                                                                ...
                                                                echo getPhrase('multiple_choice');
                                        ...
                                        <table  class="table table-bordered">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><b><?php echo getPhrase('hour');?></b></td>
    ...
    <script type="text/javascript">
        $(document).ready(function() 
        {
            $('#question_type').on('change', function() {
                ...
                if (question_type == '') {
                    $('#question_holder').html('<div class="alert alert-danger"><?php echo getPhrase('select_an_question');?></div>');
                    return;
                }
