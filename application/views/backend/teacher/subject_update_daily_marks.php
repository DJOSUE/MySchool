                            ...
                            <article class="hentry post thumb-full-width">
                                ...
                                <div class="edu-posts cta-with-media">
                                    <div style="padding:0% 0%">
                                        <?= form_open(base_url() . 'teacher/subject_update_daily_marks/'.$data, array('class' => 'form'));?>
                                        <div class="row">
                                            <div class="col">
                                            ...
                                            <div class="col">
                                                <div class="form-group label-floating is-select">
                                                    <label class="control-label"><?= getPhrase('units');?></label>
                                                    <div class="select">
                                            ...
                                            <div class="col">
                                                <div class="form-group label-floating is-select">
                                                    <label class="control-label"><?= getPhrase('date');?></label>
                                                    <input name="mark_date" id="mark_date" type="date"
                                            ...
                                            <div class="col">
                                                <button class="btn btn-success btn-upper"
                                                    type="submit"><?= getPhrase('search');?>
                                                </button>
                                                <a class="btn btn-secondary btn-rounded" style="color: white;"
                                                    onclick="add_daily_marks('<?= $data;?>')"><?= getPhrase('add');?></a>
                                            </div>
                                        </div>
                                        <?= form_close();?>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-1">
                                            <a class="btn btn-secondary btn-rounded" style="color: white;"
                                                onclick="edit_daily_marks('update_daily_marks_process')"><?= getphrase('edit');?></a>
                                        </div>
                                        <div class="col-sm-1">
                                            <button class="btn btn-danger btn-upper" id="btn_update" type="submit"
                                                disabled><?= getphrase('save');?>
                                            </button>
                                        </div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                <tr style="height:25px;">
                                                    ...
                                                    <td>
                                                        <center>
                                                            <label name="unit_id_<?= $item['mark_id'];?>"
...
function add_daily_marks(data) {
    ...
    if (unit_id == '' || mark_date == '') {
        ...
        var URL = '<?= base_url();?>teacher/add_daily_marks/' + student_id + '/' + unit_id + '/' + mark_date + '/' +
            data;
        console.log(URL);
