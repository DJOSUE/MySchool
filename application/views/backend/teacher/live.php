...
<div class="content-w">
    ...
    <script>
        ...
        var options = {
            userInfo : { 
                email : '<?php echo $this->db->get_where('teacher', array('teacher_id' => get_login_user_id()))->row()->email;?>' , 
                displayName : '<?php echo $this->crud->get_name('teacher', get_login_user_id());?>',
                moderator: true,
            },
