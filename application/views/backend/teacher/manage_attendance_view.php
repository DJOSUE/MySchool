            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        <li class="navs-item">
                            <a class="navs-links active"><i class="os-icon picons-thin-icon-thin-0729_student_degree_science_university_school_graduate"></i><span><?php echo getPhrase('attendance');?></span></a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <div class="content-box">
                    <?php echo form_open(base_url() . 'teacher/attendance_selector/', array('class' => 'form m-b'));?>
                        <div class="row">
                            ...
                            <div class="col-sm-3">
		                        <button class="btn btn-success" style="margin-top:10px" type="submit"><?php echo getPhrase('update');?></button>
		                    </div>
                        </div>
                            ...
                            <?php echo form_open(base_url() . 'teacher/attendance_update/' . $class_id . '/' . $section_id . '/' . $timestamp); ?>
                                <div class="post__author author vcard inline-items">
                                    ...
                                    <div class="author-date">
                                        <a class="h6 post__author-name fn" href="javascript:void(0);"><?php echo getPhrase('attendance');?> <small>(<?php echo date("m/d/Y", $timestamp); ?>)</small>.</a>
                                    </div>                
                                </div>  
