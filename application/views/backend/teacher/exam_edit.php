                ...
                <div class="os-tabs-w menu-shad">
                    <div class="os-tabs-controls">
                        <ul class="navs navs-tabs upper">
                            ...
                            <li class="navs-item">
                                <a class="navs-links" href="<?php echo base_url();?>teacher/exam_results/<?php echo $online_exam_id;?>/"><i class="os-icon picons-thin-icon-thin-0100_to_do_list_reminder_done"></i><span><?php echo getPhrase('results');?></span></a>
                            </li>
                            <li class="navs-item">
                                <a class="navs-links active" href="<?php echo base_url();?>teacher/exam_edit/<?php echo $online_exam_id;?>/"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new"></i><span><?php echo getPhrase('edit');?></span></a>
                            </li>
                        </ul>
                    </div>
                </div>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group is-select">
                                                ...
                                                <div class="select">
                                                    <select name="results" required="">
                                                        ...
                                                        <option value="1" <?php if($online_exam['results'] == 1) echo 'selected';?>><?php echo getPhrase('keep_hidden');?></option>
                                                        <option value="2" <?php if($online_exam['results'] == 2) echo 'selected';?>><?php echo getPhrase('show_when_exam_is_finished');?></option>
                                                        <option value="3" <?php if($online_exam['results'] == 3) echo 'selected';?>><?php echo getPhrase('15_minutes_after_finished');?></option>
                                                        <option value="4" <?php if($online_exam['results'] == 4) echo 'selected';?>><?php echo getPhrase('30_minutes_after_finished');?></option> 
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12" style="text-align: center;">
                                                <button type="submit" class="btn btn-success"><?php echo getPhrase('update');?></button>
                                            </div>
                                        </div>
                                    </div>
                                <?php echo form_close();?>
