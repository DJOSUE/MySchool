<?php  $edit_data = $this->db->get_where('homework_files' , array('delivery_id' => $param2) )->result_array();?>    
    <div class="modal-body">
        <div class="modal-header" style="background-color:#00579c">
            <h6 class="title" style="color:white"><?php echo getPhrase('files');?></h6>
        </div>
                ...
                <div class="table-responsive">
                    <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                        <thead>
                            <tr>
                                <td>#</td>
                                <td><?php echo getPhrase('student');?></td>
                                <td><?php echo getPhrase('date');?></td>
                                <td><?php echo getPhrase('file');?></td>
                            </tr>
                        </thead>
                        <tbody>
                        <?php 
                        ...
                        ?>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url();?>public/uploads/homework_delivery/<?php echo $row['file'];?>" target="_blank"><?php echo getPhrase('download');?></a></td>
                            </tr>
                        <?php endforeach;?>
                        </tbody>
                    </table>    
