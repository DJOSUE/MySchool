    <div class="full-chat-middle">
        <div class="chat-head">
            ...
            <div class="user-info">
                ...
                <a class="btn btn-success btn-sm" href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/group_info/<?php echo $current_message_thread_code;?>');"><?php echo getPhrase('group_members');?></a>
            </div>
        </div> 
