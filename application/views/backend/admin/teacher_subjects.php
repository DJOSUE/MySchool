                                ...
                                <div class="user-profile">
                                    ...
                                    <div class="ui-block">
                                        <div class="ui-block-title">
                                            <h6 class="title"><?php echo getPhrase('assigned_subjects');?></h6>
                                        </div>
                                        <div class="ui-block-content">
                                            <div class="row">
                                                <?php 
										            $this->db->order_by('subject_id', 'desc');
										            $subjects = $this->db->get_where('v_subject', array('teacher_id' => $teacher_id, 'year' => $running_year, 'semester_id' => $running_semester))->result_array();
                                                            ...
                                                            <div class="friend-item-content">
                                                                <div class="friend-avatar">
                                                                    <div class="author-thumb">
                                                                        <img src="<?php echo base_url();?>public/uploads/subject_icon/<?php echo $subject['icon'];?>"
                                                                            width="120px"
                                                                            style="background-color:#<?php echo $subject['color'];?>;padding:30px;border-radius:0px;">
                                                                    </div>
                                                                    <div class="author-content">
                                                                        <a href="javascript:void();"
                                                                            class="h5 author-name"><?php echo $subject['name'];?>
																		</a>
																		<br>
                                                                        <span>
