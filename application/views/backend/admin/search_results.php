                    ...
                    <div class="col  col-sm-12 col-12">
                        <div class="ui-block">
                            <div class="ui-block-title">
                                <h6 class="title"><?php echo getPhrase('search_results');?></h6>
                            </div>
                            <?php 
                                ...
                                <li>
                                    ...
                                    <div class="notification-event">
                                        <a href="<?php echo base_url();?>admin/student_portal/<?php echo $row['student_id'];?>/"
                                            class="h6 notification-friend"><?php echo $this->crud->get_name('student', $row['student_id']) ;?></a>.
                                        <span class="notification-date">
                                            <span class="badge badge-info">
                                                <?php 
													echo $this->db->get_where('class_room', array('classroom_id' => $row['classroom_id']))->row()->name;
												?>
                                            </span>
                            ...
                            <div class="bg-danger">
                                <div class="container">
                                    <div class="col-sm-12"><br><br>
                                        <h3 class="text-white"> <?php echo getPhrase('no_results_found');?></h3><br><br>
                                    </div>
                                </div>
                            </div>
                            <?php endif;?>
