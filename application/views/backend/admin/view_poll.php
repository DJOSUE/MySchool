	                ...
	                <div class="content-box">
		                ...
		                <div class="pipeline white lined-success">
                                        ...
                                        ?>
                                            <div class="legend-value-w">
                                                ...
                                                <div class="legend-value"><?php echo $array[$i];?> 
    					                            <span class="gi">- <?php echo $res;?> <?php echo getPhrase('users');?>.</span>
                                                </div>
                                            </div>
                                        <?php endfor;?>
                                        </div>
                            ...
                            <div class="element-box">
                                <div class="row">
                                    <div class="col-sm-12">
                                        <h4><?php echo getPhrase('participants');?></h4>
                                        <div class="col-sm-12">
                                                ...
                                                <?php 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <?php if($arrays[0] == "accountant"):?>
                                                            <a class="btn nc btn-sm btn-rounded btn-info" href="#"><?php echo getPhrase('accountant');?></a>
                                                        <?php endif;?>
                                                        <?php if($arrays[0] == "librarian"):?>
                                                            <a class="btn nc btn-sm btn-rounded btn-warning" href="#"><?php echo getPhrase('librarian');?></a>
                                                        <?php endif;?>
                                                        </td>
