                        ...
                        <div class="col-sm-8">
                            <div class="ui-block responsive-flex">
                                <table class="open-topic-table" id="panel">
                                    <thead>
                                        <tr>
                                            <th class="author"><?php echo getPhrase('author');?></th>
                                            <th class="posts"><?php echo getPhrase('topic');?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="posts">
                                                ...
                                                <?php if($row['file_name'] != ""):?>
                                                    <?php echo getPhrase('file');?>: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url();?>public/uploads/forum/<?php echo $row['file_name'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo $row['file_name'];?></a>
                                                <?php endif;?>
                                            </td>
                                        </tr>
                                        <?php
                            ...
                            <div class="element-box shadow lined-success">
                                <div class="row" style="margin:2px;margin-bottom:15px">
                                    <div class="col-sm-12">
                                        ...
                                        <div class="form-group is-empty"><textarea class="form-control" placeholder="<?php echo getPhrase('write_message');?>..." id="message" name="message" required="" rows="5" style="width:100%"></textarea><span class="material-input"></span></div>
                        ...
                        <div class="col-sm-4 ">
                            <div class="eduappgt-sticky-sidebar">
                                <div class="ui-block paddingtel">
                                    ...
                                    <?php $students = $this->db->get_where('enroll' , array('class_id' => $row['class_id'], 'section_id' => $row['section_id'], 'subject_id' => $subject_id, 'year' => $running_year))->result_array();
