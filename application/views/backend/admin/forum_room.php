    ...
    <div class="conty">
        <div class="content-i">
            <div class="content-box">
                <div class="back">
                    <a
                        href="<?= base_url();?>admin/forum/<?= base64_encode($row['class_id']."-".$row['section_id']."-".$row['subject_id']);?>/"><i
...
$(document).ready(function() {
    $("#add").click(function() {
        ...
        if (message != "" && post_code != "") {
            $.ajax({
                url: "<?= base_url();?>admin/forum_message/add",
                type: 'POST',
                data: {
                    message: message,
                    post_code: post_code
                ...
                success: function(result) {
                    ...
                    Toast.fire({
                        icon: 'success',
                        title: '<?= getPhrase('comment_success');?>'
                    });
                }
            });
        }
