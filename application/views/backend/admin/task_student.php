<?php 
    ...
    if($program_id != '_blank')
    {   
        $this->db->where('program_id', $program_id);
    }

    $this->db->where('user_type' , 'student');
    $task_query = $this->db->get('v_task_students');
                            ...
                            <div class="content-i">
                                <div class="content-box">
                                    ...
                                    <div class="row" style="margin-top: -30px; border-radius: 5px;">
                                        ...
                                        <div class="col-sm-2">
                                            <div class="form-group label-floating is-select">
                                                <label class="control-label"><?= getPhrase('type_student');?></label>
                                                <div class="select">
                                ...
                                <table class="table table-padded" id="dvData">
                                    ...
                                    <tbody>
                                        ...
                                        <tr style="height:25px;">
                                            ...
                                            <td>
                                                <center>
                                                    <?= $this->studentModel->get_program_name($row['program_id']);?>
                                                </center>
                                            </td>
                                            <td>
                                                <center>
