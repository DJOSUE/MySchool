    ...
    <div class="conty">
        <div class="os-tabs-w menu-shad">
            <div class="os-tabs-controls">
                ...
                <li class="navs-item">
                        <a class="navs-links" href="<?= base_url();?>admin/task_dashboard/">
                            <i class="os-icon picons-thin-icon-thin-0482_gauge_dashboard_empty"></i>
                            <span><?= getPhrase('dashboard');?></span>
                        </a>
                    </li>
                    <li class="navs-item">
                        <a class="navs-links" href="<?= base_url();?>admin/task_list/">
                            <i class="os-icon picons-thin-icon-thin-0093_list_bullets"></i>
                            <span><?= getPhrase('task_list');?></span>
                        </a>
                    </li>
                    <li class="navs-item">
                        <a class="navs-links" href="<?= base_url();?>admin/task_applicant/">
                            <i class="os-icon picons-thin-icon-thin-0716_user_profile_add_new"></i>
                            <span><?= getPhrase('task_applicants');?></span>
                        </a>
                    </li>
                    <li class="navs-item">
                        <a class="navs-links active" href="<?= base_url();?>admin/task_student/">
                            <i
                                class="os-icon picons-thin-icon-thin-0729_student_degree_science_university_school_graduate"></i>
                            <span><?= getPhrase('task_students');?></span>
                        </a>
                    </li>
                </ul>
            </div>
                ...
                <div class="content-box">
                    <div class="element-box-tp">
                        ...
                        <div class="row">
                            <div class="content-i">
                                <div class="content-box">
                                    <?= form_open(base_url() . 'admin/task_student/', array('class' => 'form m-b'));?>
...
$("#btnExport").click(function(e) {
    var reportName = '<?= getPhrase('task_student').'_'.date('d-m-Y');?>';
