    ...
    <div class="element-box">
        <h5 class="form-header"><?php echo getPhrase('student_promotion');?></h5>
	    <div class="table-responsive">
            <table class="table table-lightborder table-bordered">
			    <thead>
    				<tr style="background:#22b9ff;">
					    <td class="text-white"><strong><?php echo getPhrase('name');?></strong></td>
					    <td align="center" class="text-white"><strong><?php echo getPhrase('current_section');?></strong></td>
					    <td align="center" class="text-white"><strong><?php echo getPhrase('roll');?></strong></td>
					    <td align="center" class="text-white"><strong><?php echo getPhrase('to_section');?></strong></td>
					    <td align="center" class="text-white"><strong><?php echo getPhrase('options');?></strong></td>
				    </tr>
			    </thead>
			    <tbody>
			    <?php 
				    ...
				    <tr>
					    ...
					    <td>
                                ...
                                <div class="select">
                                    <select name="promotion_status_<?php echo $row['student_id'];?>" required="" id="promotion_status">
    								    <option value="<?php echo $class_id_to;?>">
    									    <?php echo getPhrase('promote_to') ." - ". $this->crud->get_class_name($class_id_to);?>
								        </option>
							        </select>
							    </div>
                            </div>
    						...
    						<center><button class="btn btn-primary" type="button"><i class="picons-thin-icon-thin-0154_ok_successful_check"></i> <?php echo getPhrase('promoted');?></button></center>
						    <?php endif;?>
					    </td>
				    </tr>
			    <?php endforeach;?>
    ...
    <br>
	<center><button class="btn btn-success" type="submit"><i class="icon-paper-plane"></i>  <?php echo getPhrase('promote');?></button></center>
