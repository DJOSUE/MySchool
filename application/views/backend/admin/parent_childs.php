										    ...
										    <div class="ui-block-content">
    										    <div class="table-responsive">
                                                    <table width="100%" class="table table-lightborder table-lightfont">
                                                        <thead>
                                                            <tr>
                                                                <th style="text-align: left;"><?php echo getPhrase('student');?></th>
                                                                <th style="text-align: center;"><?php echo getPhrase('class');?></th>
                                                                <th style="text-align: center;"><?php echo getPhrase('section');?></th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
