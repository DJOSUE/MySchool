                        ...
                        <div class="form-group label-floating is-select">
                            ...
                            <div class="select">
                                <select name="student_session">
                                    <option value=""><?php echo getPhrase('select');?></option>
                                    <option value="1" <?php if($row['student_session'] == 1) echo 'selected';?>><?php echo getPhrase('active');?></option>
                                    <option value="2" <?php if($row['student_session'] != 1) echo 'selected';?>><?php echo getPhrase('inactive');?></option>
                                </select>
                            </div>
                        </div>
                    </div>
