                                            ...
                                            <ul class="help-support-list">
                                                ...
                                                <li>
                                                    <i class="picons-thin-icon-thin-0133_arrow_right_next"
                                                        style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
                                                    <a
                                                        href="<?php echo base_url();?>admin/placement_achievement/<?php echo $student_id;?>/">
                                                        <?php echo getPhrase('placement_and_achievement');?>
                                                    </a>
                                                </li>
                                                <li>
                                                    <i class="picons-thin-icon-thin-0133_arrow_right_next"
                                                ...
                                                <li>
                                                    <i class="picons-thin-icon-thin-0329_computer_laptop_user_login"
                                                        style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
                                                    <a
                                                        href="<?php echo base_url();?>admin/login_as/student/<?php echo $student_id;?>/"><?php echo getPhrase('login_as');?></a>
                                                </li>
                                                <?php endif;?>
                                            </ul>
                                        </div>
