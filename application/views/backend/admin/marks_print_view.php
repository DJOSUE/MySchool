                            ...
                            <div class="rcard-table table-responsive">
                                <table class="table">
                                    ...
                                    <?php 
                                        ...
                                        $mark = $this->db->get_where('mark' , array('student_id' => $student_id,'subject_id' => $row3['subject_id'], 'class_id' => $class_id, 'unit_id' => $unit_id, 'year' => $running_year));    
                                        if($mark->num_rows() > 0) 
                                        {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $this->db->get_where('mark' , array('subject_id' => $row3['subject_id'], 'unit_id' => $unit_id, 'student_id'=> $student_id,'year' => $running_year))->row()->labtotal;?></td>
                                            <td class="text-center"><?php echo $this->db->get_where('mark' , array('subject_id' => $row3['subject_id'], 'unit_id' => $unit_id, 'student_id'=> $student_id,'year' => $running_year))->row()->comment;?></td>
                                        </tr>
