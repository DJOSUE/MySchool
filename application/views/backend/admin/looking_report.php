	            ...
	            <div class="row">
	                <div class="col-sm-8">
		                <div class="pipeline white lined-primary">
			                ...
			                <div class="b-t padded-v-big"><a class="btn btn-rounded btn-sm btn-success" onClick="return confirm('<?php echo getPhrase('confirm_solved');?>')" href="<?php echo base_url();?>admin/create_report/update/<?php echo $row['code'];?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0154_ok_successful_check"></i> <?php echo getPhrase('mark_solved');?></a></div>
			                <?php endif;?>
		                </div>
