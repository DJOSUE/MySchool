            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        ...
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>admin/system_translate/">
                                <i
                        ...
                        <div class="col-sm-12">
                            <div class="element-box shadow shadow lined-primary" style="border-radius:10px;">
                                <button class="btn btn-rounded btn-success" data-toggle="modal"
                                    data-target="#addlang"><?php echo getPhrase('add_language');?></button>
                                <hr>
                                <?php if (isset($edit_profile)):?>
                                <?php $current_editing_language = $edit_profile;?>
                                <div class="row">
                                    <input type="hidden" name="current" value="<?php echo $current_editing_language;?>"
                                        id="current">
                                    <?php 
                                        $count = 1;
                                        ...
                                        ?>
                                    <div class="col-sm-3">
                                        <div class="element-box infodash centered padded"
                                            style="background: #a01a7a; border-radius:15px;">
                                            <div class="bg-icon">
                                            ...
                                            <input class="form-control" id="phrase-<?php echo $row['phrase'];?>"
                                                value="<?php echo $phrase_language;?>" type="text"
                                                name="phrase<?php echo $row['phrase_id'];?>"
                                                style="border-radius:5px; background-color:#fff;">
                                            <button class="btn btn-success"
                                                onclick="updateLang('<?php echo $row['phrase'];?>')"
                                                id="btn-<?php echo $row['phrase'];?>"><i
                                                    ...
                                                    <div class="user-w">
                                                        <div class="user-avatar-w">
                                                            <div class="user-avatar">
                                                                <img alt=""
                                                                    src="<?php echo base_url();?>public/style/flags/<?php echo $data[$i];?>.png">
                                                            </div>
                                                        </div>
                                                        <div class="user-name">
        ...
        <div class="modal-dialog window-popup edit-widget edit-widget-twitter" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#00579c">
                    ...
                    <a href="javascript:void(0);" class="more" aria-label="Close" class="close" data-dismiss="modal"><i
                ...
                <div class="modal-body">
                    ...
                    <button class="btn btn-rounded btn-purple  btn-icon-left"
