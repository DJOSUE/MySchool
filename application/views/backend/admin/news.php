                                    ...
                                    <div class="post__author author vcard inline-items">
                                        ...
                                        <div class="more">
                                            ...
                                            <ul class="more-dropdown">
                                                <li><a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_news/<?php echo $wall['news_code'];?>');"><?php echo getPhrase('edit');?></a></li>
                                                <li><a onClick="return confirm('<?php echo getPhrase('confirm_delete');?>')"  href="<?php echo base_url();?>admin/news/delete2/<?php echo $wall['news_code'];?>"><?php echo getPhrase('delete');?></a></li>
                                            </ul>
                                        </div>
                                    </div>
