                						    ...
                						    <div class="help-support-block">
											    ...
											    <ul class="help-support-list">
    												<li>
    													...
    													<a href="<?php echo base_url();?>admin/my_account/"><?php echo getPhrase('personal_information');?></a>
    												</li>
												    <li>
    													<i class="picons-thin-icon-thin-0133_arrow_right_next px20"></i> &nbsp;&nbsp;&nbsp;
													    <a href="<?php echo base_url();?>admin/update_account/"><?php echo getPhrase('update_information');?></a>
												    </li>
											    </ul>
										    </div>
									    </div>
											...
											<div class="pricing-plans row no-gutters">
												<div class="pricing-plan col-sm-6">
													...
													<div class="plan-body"><br><br>
														...
														<?php else:?>
															<a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>admin/my_account/remove_facebook/"><?php echo getPhrase('unlink');?></a>
														<?php endif;?>
														</div>
													</div>
												</div>
												<div class="pricing-plan col-sm-6">
													...
													<div class="plan-body"><br><br>
														...
														<?php else:?>
															<a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>admin/my_account/remove_google/"><?php echo getPhrase('unlink');?></a>
														<?php endif;?>
														</div>
													</div>
												</div>
