                    ...
                    <div class="top-header-thumb">
                        ...
                        <div class="top-header-author">
                            ...
                            <div class="author-content">
                                <a href="javascript:void(0);" class="h3 author-name"><?php echo getPhrase('school_bus');?></a>
                                    ...
                                    <table class="table table-padded">
                                        <thead>
                                            <tr>
    					                        ...
    					                        <th><?php echo getPhrase('route');?></th>
					                            <th><?php echo getPhrase('bus_id');?></th>
					                            <th><?php echo getPhrase('driver');?></th>
					                            <th><?php echo getPhrase('driver_phone');?></th>
				                        ...
				                        ?>
				                            <tr>
    					                        ...
    					                        <td>
						                            <a class="grey" href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_bus/<?php echo $buss['transport_id'];?>');"><i class="picons-thin-icon-thin-0729_student_degree_science_university_school_graduate"></i></a>
    						                        <a class="grey" href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_transport/<?php echo $buss['transport_id'];?>');"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i></a>
						                            <a class="grey" onClick="return confirm('<?php echo getPhrase('confirm_delete');?>')" class="danger" href="<?php echo base_url();?>admin/school_bus/delete/<?php echo $buss['transport_id'];?>"><i class="picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i></a>
					                            </td>
				                            </tr>
				                        <?php endforeach;?>
                                        </tbody>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="modal-header" style="background-color:#00579c">
                        <h6 class="title" style="color:white"><?php echo getPhrase('new_bus');?></h6>
                    </div>
                    <div class="ui-block-content">
                        <?php echo form_open(base_url() . 'admin/school_bus/create/' , array('enctype' => 'multipart/form-data'));?>
                            <div class="row">
                                ...
                                <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group label-floating">
                                        <label class="control-label"><?php echo getPhrase('route');?></label>
                                        <input class="form-control" type="text" name="route" required="">
                                    </div>
                                </div>
                                <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group label-floating">
                                        <label class="control-label"><?php echo getPhrase('bus_id');?></label>
                                        <input class="form-control" type="text" name="number_of_vehicle" required="">
                                    </div>
                                </div>
                                <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group label-floating">
                                        <label class="control-label"><?php echo getPhrase('driver_name');?></label>
                                        <input class="form-control" type="text" name="driver_name" required="">
                                    </div>
                                </div>
                                <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                                    <div class="form-group label-floating">
                                        <label class="control-label"><?php echo getPhrase('driver_phone');?></label>
