												...
												<div class="top-header-thumb">
													...
													<div class="top-header-author">
														...
														<div class="author-content">
															<a href="javascript:void(0);" class="h3 author-name"><?php echo getPhrase('accountants');?></a>
                                                                    ...
                                                                    <div class="card-box widget-user ui-block list">
                                                                        <div class="more" class="pull-right">
                                                                            ...
                                                                            <ul class="more-dropdown">
                                                                                <li><a href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_accountant/<?php echo $row['accountant_id'];?>');"><?php echo getPhrase('edit');?></a></li>
                                                                                <li><a onClick="return confirm('<?php echo getPhrase('confirm_delete');?>')" href="<?php echo base_url();?>admin/accountant/delete/<?php echo $row['accountant_id'];?>"><?php echo getPhrase('delete');?></a></li>
                                                                            </ul>
                                                                        </div>
                                                                        <div>
                    ...
                    <div class="ui-block-content">
                        <?php echo form_open(base_url() . 'admin/accountant/create/', array('enctype' => 'multipart/form-data'));?>
                            <div class="row">
                                ...
                                <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                    <button class="btn btn-rounded btn-primary btn-lg full-width" id="sub_accountant" type="submit"><?php echo getPhrase('save');?></button>
                                </div>
                            </div>
                        <?php echo form_close();?>
                    </div>
