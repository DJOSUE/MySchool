    ...
    <div class="cuadro" id="print_area">
		...
		<table cellpading="0" cellspacing="0" border="1" style="margin: 20px 0;">
			...
			<tr style="text-align: center;" id="student-<?php echo $row['student_id'];?>">
                ...
                ?>
				<td class="text-center"><?php echo $this->db->get_where('mark', array('student_id' => $row['student_id'], 'year' => $running_year, 'unit_id' => $key['unit_id'],'subject_id' => $subject_id))->row()->labtotal;?></td>
				<?php endforeach;?>
