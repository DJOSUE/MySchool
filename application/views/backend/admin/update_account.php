                                ...
                                <div class="user-profile">
                                        ...
                                        <div class="up-main-info">
                                            <div class="user-avatar-w">
                                                <div class="user-avatar">
                                                    <img alt=""
                                                        src="<?php echo $this->crud->get_image_url('admin', $row['admin_id']);?>"
                                                        style="background-color:#fff;">
                                                </div>
                                            </div>
                                            <h3 class="text-white">
                                                <?php echo $this->crud->get_name('admin',$row['admin_id']);?></h3>
                                    ...
                                    <div class="ui-block">
                                        <div class="ui-block-title">
                                            <h6 class="title"><?php echo getPhrase('update_profile');?></h6>
                                        </div>
                                        ...
                                        <div class="help-support-block">
                                            ...
                                            <ul class="help-support-list">
                                                <li>
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;
                                                    <a
                                                        href="<?php echo base_url();?>admin/my_account/"><?php echo getPhrase('personal_information');?></a>
                                                </li>
                                                <li>
                                                    <i class="picons-thin-icon-thin-0133_arrow_right_next px20"></i>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <a
                                                        href="<?php echo base_url();?>admin/update_account/"><?php echo getPhrase('update_information');?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="plan-body"><br><br>
                                                <div class="plan-btn-w">
                                                    ...
                                                    <a class="btn btn-danger btn-rounded"
                                                        href="<?php echo base_url();?>admin/my_account/remove_facebook/"><?php echo getPhrase('unlink');?></a>
                                                    <?php endif;?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pricing-plan col-sm-6">
                                            ...
                                            <div class="plan-body"><br><br>
                                                <div class="plan-btn-w">
                                                    ...
                                                    <?php else:?>
                                                    <a class="btn btn-danger btn-rounded"
                                                        href="<?php echo base_url();?>admin/my_account/remove_google/"><?php echo getPhrase('unlink');?></a>
                                                    <?php endif;?>
                                                </div>
                                            </div>
                                        </div>
