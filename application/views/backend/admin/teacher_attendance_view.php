            ...
            <div class="os-tabs-w menu-shad">
		        <div class="os-tabs-controls">
		            <ul class="navs navs-tabs upper">
			            <li class="navs-item">
			                <a class="navs-links active" href="<?php echo base_url();?>admin/teacher_attendance/"><i class="os-icon picons-thin-icon-thin-0704_users_profile_group_couple_man_woman"></i><span><?php echo getPhrase('teacher_attendance');?></span></a>
			            </li>
			            <li class="navs-item">
			                <a class="navs-links" href="<?php echo base_url();?>admin/teacher_attendance_report/"><i class="os-icon os-icon picons-thin-icon-thin-0386_graph_line_chart_statistics"></i><span><?php echo getPhrase('teacher_attendance_report');?></span></a>
			            </li>
		            </ul>
		        </div>
	        </div>
                ...
                <div class="content-box">
                    <?php echo form_open(base_url() . 'admin/attendance_teacher/', array('class' => 'form m-b'));?>
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                <div class="form-group"> <button class="btn btn-rounded btn-primary btn-upper" style="margin-top:20px" type="submit"><span><?php echo getPhrase('view');?></span></button></div>
                            </div>
                        </div>
                    <?php echo form_close();?>
                    <div class="ui-block">
                        <article class="hentry post thumb-full-width">                
                            <div class="post__author author vcard inline-items">
                                ...
                                <div class="author-date">
                                    <a class="h6 post__author-name fn" href="javascript:void(0);"><?php echo getPhrase('teachers_attendance');?> <small>(<?php echo date("m/d/Y", $timestamp);?>)</small>.</a>
                                </div>                
                            </div>                
                                ...
                                <div class="table-responsive">
                                    <?php echo form_open(base_url() . 'admin/attendance_update2/' . $timestamp); ?>
                                        <table class="table table-lightborder">
                                            <thead>
                                                <tr class="bg-primary">
                                                    <th class="text-white"><?php echo getPhrase('teacher');?></th>
                                                    <th class="text-white" style="text-align: center;"><?php echo getPhrase('status');?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                            <?php
