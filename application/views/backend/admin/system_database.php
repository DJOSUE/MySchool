            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        ...
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>admin/database/">
                ...
                <div class="content-box">
                    <div class="element-box lined-purple shadow" style="border-radius:10px;">
                        <h4 class="form-header"><i class="picons-thin-icon-thin-0356_database"></i>
                            <?php echo getPhrase('backup_restore');?></h4><br>
                        <div class="row">
                            <div class="col-sm-6">
                                        ...
                                        <div class="friend-item-content">
                                            <div class="friend-avatar">
                                                <div class="author-thumb">
                                                    <img src="<?php echo base_url();?>public/uploads/icons/backup.svg"
                                                        width="110px"
                                                        style="background-color:#fff;padding:15px; border-radius:0px;">
                                                </div>
                                                <div class="author-content">
                                                    <a href="<?php echo base_url();?>admin/database/create/"
                                                        class="h5 author-name"><?php echo getPhrase('generate_backup');?></a>
                                                </div>
                                            </div>
                                            <div class="control-block-button">
                                                <a href="<?php echo base_url();?>admin/database/create/"
                                                    class="btn btn-control bg-success text-white"><i
                                                        class="picons-thin-icon-thin-0123_download_cloud_file_sync"></i></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="ui-block" data-mh="friend-groups-item" style="">
                                    <div class="friend-item friend-groups">
                                        <div class="friend-item-content">
                                            ...
                                            <div class="friend-avatar">
                                                <div class="author-thumb">
                                                    <img src="<?php echo base_url();?>public/uploads/icons/restore.svg"
                                                        width="110px"
                                                        style="background-color:#fff;padding:15px; border-radius:0px;">
                                                </div>
                                                <div class="author-content">
                                                    <a href="javascript:void(0);"
                                                        class="h5 author-name"><?php echo getPhrase('import_backup');?></a>
                                                </div>
                                            </div>
                                            <div class="control-block-button">
                                                <center><input id="upload3" type="file" name="file_name"
                                                        style="background-color: #99bf2d; width:250px;"></center>
                                            </div>
                                            <div class="control-block-button">
                                                <button type="submit" class="btn btn-control bg-primary text-white"><i
                                                        class="picons-thin-icon-thin-0124_upload_cloud_file_sync_backup"></i></button>
                                            </div>
                                            <?php echo form_close();?>
                                        </div>
                                    </div>
