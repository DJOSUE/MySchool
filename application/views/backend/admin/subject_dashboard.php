    ...
    <div class="conty">
        ...
        <div class="cursos cta-with-media" style="background: #<?= $row['color'];?>;">
            <div class="cta-content">
                ...
                <small
                    style="font-size:0.90rem; color:#fff;"><?= $this->db->get_where('class', array('class_id' => $class_id))->row()->name;?>
                    "<?= $this->db->get_where('section', array('section_id' => $section_id))->row()->name;?>"</small>
            </div>
        </div>
        <div class="os-tabs-w menu-shad">
            <div class="os-tabs-controls">
                <ul class="navs navs-tabs upper">
                    <li class="navs-item">
                        <a class="navs-links active" href="<?= base_url();?>admin/subject_dashboard/<?= $data;?>/"><i
                                class="os-icon picons-thin-icon-thin-0482_gauge_dashboard_empty"></i><span><?= getPhrase('dashboard');?></span></a>
                    </li>
                    <li class="navs-item">
                        <a class="navs-links" href="<?= base_url();?>admin/online_exams/<?= $data;?>/"><i
                                class="os-icon picons-thin-icon-thin-0207_list_checkbox_todo_done"></i><span><?= getPhrase('online_exams');?></span></a>
                    </li>
                    <li class="navs-item">
                        <a class="navs-links" href="<?= base_url();?>admin/homework/<?= $data;?>/"><i
                                class="os-icon picons-thin-icon-thin-0004_pencil_ruler_drawing"></i><span><?= getPhrase('homework');?></span></a>
                    </li>
                    <li class="navs-item">
                        <a class="navs-links" href="<?= base_url();?>admin/forum/<?= $data;?>/"><i
                                class="os-icon picons-thin-icon-thin-0281_chat_message_discussion_bubble_reply_conversation"></i><span><?= getPhrase('forum');?></span></a>
                    </li>
                    <li class="navs-item">
                        <a class="navs-links" href="<?= base_url();?>admin/study_material/<?= $data;?>/"><i
                                class="os-icon picons-thin-icon-thin-0003_write_pencil_new_edit"></i><span><?= getPhrase('study_material');?></span></a>
                    </li>
                    <?php if($useDailyMarks): ?>
                    <li class="navs-item">
                        <a class="navs-links" href="<?= base_url();?>admin/daily_marks/<?= $data;?>/"><i
                                class="os-icon picons-thin-icon-thin-0729_student_degree_science_university_school_graduate"></i><span><?= getPhrase('marks');?></span></a>
                    </li>
                    <li class="navs-item">
                        <a class="navs-links" href="<?= base_url();?>admin/subject_daily_marks_average/<?= $data;?>/"><i
                                class="os-icon picons-thin-icon-thin-0197_layout_grid_view"></i><span><?= getPhrase('daily_marks_average');?></span></a>
                    </li>
                    <?php else: ?>
                    <li class="navs-item">
                        <a class="navs-links" href="<?= base_url();?>admin/upload_marks/<?= $data;?>/"><i
                                class="os-icon picons-thin-icon-thin-0729_student_degree_science_university_school_graduate"></i><span><?= getPhrase('marks');?></span></a>
                    </li>
                    <?php endif; ?>
                    <li class="navs-item">
                        <a class="navs-links" href="<?= base_url();?>admin/subject_meet/<?= $data;?>/"><i
                    ...
                    <li class="navs-item">
                        <a class="navs-links" href="<?= base_url();?>admin/attendance/<?= $data;?>/"><i
                                ...
                                <article class="hentry post thumb-full-width">
                                    <div class="post__author author vcard inline-items">
                                        ...
                                        <div class="more">
                                            ...
                                            <ul class="more-dropdown">
                                                <li><a
                                                        href="<?= base_url();?>admin/homework_edit/<?= $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_code;?>/"><?= getPhrase('edit');?></a>
                                                </li>
                                                <li><a onClick="return confirm('<?= getPhrase('confirm_delete');?>')"
                                                        href="<?= base_url(); ?>admin/homework/delete/<?= $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_code;?>/<?= $data;?>/"><?= getPhrase('delete');?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="edu-posts cta-with-media verde">
                                        <div class="cta-content">
                                            ...
                                            <a
                                                href="<?= base_url();?>admin/homeworkroom/<?= $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_code;?>/"><button
                                        ...
                                        <ul class="friends-harmonic">
                                            ...
                                            <li>
                                                <a href="javascript:void(0);">
                                                    <img loading="lazy"
                                                        onclick="showAjaxModal('<?= base_url();?>modal/popup/modal_students/<?= $wall['homework_id'].'/'.$subject_id.'/homework';?>');"
                                ...
                                <article class="hentry post thumb-full-width">
                                    <div class="post__author author vcard inline-items">
                                        ...
                                        <div class="more">
                                            ...
                                            <ul class="more-dropdown">
                                                <li><a
                                                        href="<?= base_url();?>admin/exam_edit/<?= $this->db->get_where('online_exam', array('online_exam_id' => $wall['homework_id']))->row()->online_exam_id;?>/"><?= getPhrase('edit');?></a>
                                                </li>
                                                <li><a onClick="return confirm('<?= getPhrase('confirm_delete');?>')"
                                                        href="<?= base_url();?>admin/manage_exams/delete/<?= $this->db->get_where('online_exam', array('online_exam_id' => $wall['homework_id']))->row()->online_exam_id;?>/<?= $data;?>"><?= getPhrase('delete');?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="edu-posts cta-with-media verde">
                                        <div class="cta-content">
                                            <div class="highlight-header celeste"><?= $row['name'];?></div>
                                            <div class="grado">
                                                <?= $this->db->get_where('class', array('class_id' => $class_id))->row()->name;?>
                                                "<?= $this->db->get_where('section', array('section_id' => $section_id))->row()->name;?>"
                                            </div>
                                            ...
                                            <a
                                                href="<?= base_url();?>admin/examroom/<?= $this->db->get_where('online_exam', array('online_exam_id' => $wall['homework_id']))->row()->online_exam_id;?>/"><button
                                    ...
                                    <div class="post-additional-info inline-items">
                                        <ul class="friends-harmonic">
                                            ...
                                            <li>
                                                <a href="javascript:void(0);">
                                                    <img loading="lazy"
                                                        onclick="showAjaxModal('<?= base_url();?>modal/popup/modal_students/<?= $wall['homework_id'].'/'.$subject_id.'/exam';?>');"
                                                        title="<?= $this->crud->get_name('student', $readed['student_id']);?>"
                                                        src="<?= $this->crud->get_image_url('student', $readed['student_id']);?>"
                                                        alt="<?= $this->crud->get_name('student', $readed['student_id']);?>"
                                                        width="28" height="28">
                                ...
                                <article class="hentry post thumb-full-width">
                                    <div class="post__author author vcard inline-items">
                                        ...
                                        <div class="more">
                                            ...
                                            <ul class="more-dropdown">
                                                <li><a onClick="return confirm('<?= getPhrase('confirm_delete');?>')"
                                                        href="<?= base_url();?>admin/study_material/delete/<?= $this->db->get_where('document', array('document_id' => $wall['homework_id']))->row()->document_id;?>/<?= $data;?>"><?= getPhrase('delete');?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="post-additional-info inline-items">
                                        <ul class="friends-harmonic">
                                            ...
                                            <li>
                                                <a href="javascript:void(0);">
                                                    <img loading="lazy"
                                                        onclick="showAjaxModal('<?= base_url();?>modal/popup/modal_students/<?= $wall['homework_id'].'/'.$subject_id.'/material';?>');"
                                                        title="<?= $this->crud->get_name('student', $readed['student_id']);?>"
                                                        src="<?= $this->crud->get_image_url('student', $readed['student_id']);?>"
                                                        alt="<?= $this->crud->get_name('student', $readed['student_id']);?>"
                                                        width="28" height="28">
                                ...
                                <article class="hentry post thumb-full-width">
                                    <div class="post__author author vcard inline-items">
                                        ...
                                        <div class="more">
                                            ...
                                            <ul class="more-dropdown">
                                                <li><a
                                                        href="<?= base_url();?>admin/edit_forum/<?= $this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->post_code;?>/"><?= getPhrase('edit');?></a>
                                                </li>
                                                <li><a onClick="return confirm('<?= getPhrase('confirm_delete');?>')"
                                                        href="<?= base_url(); ?>admin/forum/delete/<?= $this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->post_code;?>/<?= $data;?>"><?= getPhrase('delete');?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="edu-posts cta-with-media verde">
                                        <div class="cta-content">
                                            <div class="highlight-header yellow"><?= $row['name'];?></div>
                                            <div class="grado">
                                                <?= $this->db->get_where('class', array('class_id' => $class_id))->row()->name;?>
                                                "<?= $this->db->get_where('section', array('section_id' => $section_id))->row()->name;?>"
                                            </div>
                                            ...
                                            <div class="descripcion">
                                                <?= strip_tags($this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->description);?>
                                            </div>
                                            <a
                                                href="<?= base_url();?>admin/forumroom/<?= $this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->post_code;?>/"><button
                                                    class="btn btn-rounded btn-posts"><i
                                                        class="picons-thin-icon-thin-0014_notebook_paper_todo"></i>
                                    ...
                                    <div class="post-additional-info inline-items">
                                        <ul class="friends-harmonic">
                                            ...
                                            <li>
                                                <a href="javascript:void(0);">
                                                    <img loading="lazy"
                                                        onclick="showAjaxModal('<?= base_url();?>modal/popup/modal_students/<?= $wall['homework_id'].'/'.$subject_id.'/forum';?>');"
                                                        title="<?= $this->crud->get_name('student', $readed['student_id']);?>"
                                                        src="<?= $this->crud->get_image_url('student', $readed['student_id']);?>"
                                                        alt="<?= $this->crud->get_name('student', $readed['student_id']);?>"
                                                        width="28" height="28">
                                ...
                                <div class="ui-block paddingtel">
                                    ...
                                    <div class="ui-block-content">
                                        <div style="margin-bottom:10px">
                                            <span
                                                class="subjectCounter"><?= $this->academic->countOnlineExams($class_id,$section_id,$subject_id);?></span>
                                            <span class="counterText"><?= getPhrase('online_exams');?>.</span>
                                        </div>
                                        <div style="margin-bottom:10px">
                                            <span
                                                class="subjectCounter"><?= $this->academic->countHomeworks($class_id,$section_id,$subject_id);?></span>
                                            <span class="counterText"><?= getPhrase('homeworks');?>.</span>
                                        </div>
                                        <div style="margin-bottom:10px">
                                            <span
                                                class="subjectCounter"><?= $this->academic->countForums($class_id,$section_id,$subject_id);?></span>
                                            <span class="counterText"><?= getPhrase('forums');?>.</span>
                                        </div>
                                        <div style="margin-bottom:10px">
                                            <span
                                                class="subjectCounter"><?= $this->academic->countMaterial($class_id,$section_id,$subject_id);?></span>
                                            <span class="counterText"><?= getPhrase('study_material');?>.</span>
                                        </div>
                                        <div style="margin-bottom:10px">
                                            <span
                                                class="subjectCounter"><?= $this->academic->countLive($class_id,$section_id,$subject_id);?></span>
