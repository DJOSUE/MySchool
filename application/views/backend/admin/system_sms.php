            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        ...
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>admin/system_sms/">
                            ...
                            <div class="content-box">
                                <div class="col-sm-12">
                                    ...
                                    <div class="element-box shadow shadow lined-purple" style="border-radius:10px;">
                                        <div class="col-sm-12">
                                            <div class="form-group label-floating is-select">
                                                <label
                                                    class="control-label"><?php echo getPhrase('sms_service');?></label>
                                                <div class="select">
                                                    <select name="sms_status" onchange="submit();">
                                                        <option value="deactivate"
                                                            <?php if($status == 'deactivate') echo 'selected';?>>
                                                            <?php echo getPhrase('disabled');?></option>
                                                        <option value="clickatell"
                                                            <?php if($status == 'clickatell') echo 'selected';?>>
                                                            Clickatell</option>
                                                        <option value="twilio"
                                                            <?php if($status == 'twilio') echo 'selected';?>>Twilio
                                                        </option>
                                                        <option value="msg91"
                                                            <?php if($status == 'msg91') echo 'selected';?>>MSG91
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                            ...
                                            <div class="element-box shadow shadow lined-primary"
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input class="form-control" required
                                                            value="<?php echo $this->crud->getInfo('clickatell_username');?>"
                                                            type="text" name="clickatell_username" required="">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input class="form-control" required
                                                            value="<?php echo $this->crud->getInfo('clickatell_password');?>"
                                                            type="text" name="clickatell_password" required="">
                                                        <span class="material-input"></span>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input class="form-control" required
                                                            value="<?php echo $this->crud->getInfo('clickatell_api');?>"
                                                            type="text" name="clickatell_api" required="">
                                                        <span class="material-input"></span>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="element-box shadow lined-danger" style="border-radius:10px;">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input class="form-control" required
                                                            value="<?php echo $this->crud->getInfo('twilio_account');?>"
                                                            type="text" name="twilio_account" required="">
                                                        <span class="material-input"></span>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input class="form-control" required
                                                            value="<?php echo $this->crud->getInfo('authentication_token');?>"
                                                            type="text" name="authentication_token" required="">
                                                        <span class="material-input"></span>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input class="form-control" required
                                                            value="<?php echo $this->crud->getInfo('registered_phone');?>"
                                                            type="text" name="registered_phone" required="">
                                                        <span class="material-input"></span>
                                                    </div>
                                                </div>
                                                <div class="form-buttons-w text-right">
                                                    <button class="btn btn-rounded btn-danger" type="submit">
                                                        <?php echo getPhrase('update');?> </button>
                                                </div>
                                                <?php echo form_close();?>
                                            </div>
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input class="form-control"
                                                            value="<?php echo $this->crud->getInfo('msg91_key');?>"
                                                            type="text" name="msg91_key" required="">
                                                        <span class="material-input"></span>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input class="form-control"
                                                            value="<?php echo $this->crud->getInfo('msg91_sender');?>"
                                                            type="text" name="msg91_sender" required="">
                                                        <span class="material-input"></span>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input class="form-control"
                                                            value="<?php echo $this->crud->getInfo('msg91_route');?>"
                                                            type="text" name="msg91_route" required="">
                                                        <span class="material-input"></span>
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group label-floating">
                                                        ...
                                                        <input class="form-control"
                                                            value="<?php echo $this->crud->getInfo('msg91_code');?>"
                                                            type="text" name="msg91_code" required="">
                                                        <span class="material-input"></span>
                                                    </div>
                                                </div>
                                                <div class="form-buttons-w text-right">
                                    ...
                                    <div class="element-box lined-primary shadow" style="border-radius:10px;">
                                        <h3 class="form-header"><?php echo getPhrase('notify_send');?></h3><br>
                                        <div class="row">
                                            <div class="col-sm-6">
                                                <h4><?php echo getPhrase('for_parents');?></h4>
                                                <hr>
                                                <div class="description-toggle">
                                                    <div class="description-toggle-content">
                                                        <div class="h6"><?php echo getPhrase('absences');?></div>
                                                        <p><?php echo getPhrase('absences_message');?></p>
                                                    </div>
                                                    <div class="togglebutton">
                                                        <label><input name="absences" value="1" type="checkbox"
                                                                <?php if($this->crud->getInfo('absences') == 1) echo "checked";?>></label>
                                                    </div>
                                                </div>
                                                <br>
                                                <div class="description-toggle">
                                                    <div class="description-toggle-content">
                                                        <div class="h6"><?php echo getPhrase('students_reports');?>
                                                        </div>
                                                        <p><?php echo getPhrase('students_reports_message');?></p>
                                                    </div>
                                                    <div class="togglebutton">
                                                        <label><input name="students_reports" value="1" type="checkbox"
                                                ...
                                                <div class="description-toggle">
                                                    <div class="description-toggle-content">
                                                        <div class="h6"><?php echo getPhrase('new_invoice');?></div>
                                                        <p><?php echo getPhrase('new_invoice_message');?></p>
                                                    </div>
                                                    <div class="togglebutton">
                                                        <label><input name="p_new_invoice" value="1" type="checkbox"
                                                                <?php if($this->crud->getInfo('p_new_invoice') == 1) echo "checked";?>></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-6">
                                                <h4><?php echo getPhrase('for_students');?></h4>
                                                <hr>
                                                <div class="description-toggle">
                                                    <div class="description-toggle-content">
                                                        <div class="h6"><?php echo getPhrase('new_invoices');?></div>
                                                        <p><?php echo getPhrase('new_invoice_message');?></p>
                                                    </div>
                                                    <div class="togglebutton">
                                                        <label><input name="s_new_invoice" value="1" type="checkbox"
                                                                <?php if($this->crud->getInfo('s_new_invoice') == 1) echo "checked";?>></label>
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
