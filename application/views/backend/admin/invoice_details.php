            ...
            <div class="content-i">
	            <div class="content-box">
	                <div class="element-wrapper">
	                    <a href="<?php echo base_url();?>admin/students_payments/" class="btn btn-rounded btn-info"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i> <?php echo getPhrase('return');?></a>
	                    <button type="button" class="btn btn-rounded btn-success" onclick="Print('invoiceid')"><?php echo getPhrase('print_invoice');?></button>
		                    ...
		                    <div class="infos">
			                    <div class="info-1">
			                        ...
			                        <div class="company-extra" style="color:#000;">
				                        <?php echo getPhrase('phone');?>: <?php echo $this->crud->getInfo('phone');?>
			                        </div>
			                    </div>
                			    <div class="info-2" style="float:right"><br><br>
                			        ...
                			        <div class="company-address text-dark">
                				        <?php echo getPhrase('roll');?>: <strong><?php echo $this->db->get_where('enroll', array('student_id' => $row['student_id']))->row()->roll;?></strong><br/>
                				        <?php echo $this->db->get_where('class', array('class_id' => $row['class_id']))->row()->name;?><br/>
                    			    </div>
                			    </div>
		                    </div>
		                    <div class="invoice-heading">
			                    <h3><?php echo getPhrase('invoice');?></h3>
			                        ...
			                        <table class="table">
				                        <thead>
				                            <tr>
					                            ...
					                            <th class="text-right"><?php echo getPhrase('amount');?></th>
				                            </tr>
				                        </thead>
				                        <tbody>
				                            <tr>
