    <?php 
        ...
        $add_schedule = has_permission('add_schedule');
    ?>
    <div class="content-w">
            ...
            <div class="content-box">
                <div class="row">
                            ...
                            <div class="select">
                                <select onchange="submit();" name="class_id" onchange="submit();">
                                    ...
                                    <option value="<?php echo $row['class_id'];?>"
                                        <?php if($id == $row['class_id']) echo 'selected';?>><?php echo $row['name'];?>
                                    </option>
                                    <?php endforeach;?>
                                </select>
                            </div>
                    ...
                    <div class="col col-lg-3 col-md-3 col-sm-12 col-12">
                        <div class="text-">
                            <button class="btn btn-rounded btn-success btn-upper" data-target="#addroutine"
                                data-toggle="modal" type="button">+ <?php echo getPhrase('add_schedule');?></button>
                        </div>
                    </div>
                    <?php endif;?>
                </div>
                <div class="" style="padding-top:25px; padding-left:18px;">
                    <div class="os-tabs-w">
                        <div class="os-tabs-controls">
                            <ul class="navs navs-tabs upper">
                                <?php $query = $this->db->get_where('section' , array('class_id' => $id, 'year' => $running_year, 'semester_id' => $running_semester)); 
                                if ($query->num_rows() > 0):
                                $sections = $query->result_array();
                                foreach ($sections as $rows):?>
                                <li class="navs-item">
                                    <a class="navs-link <?php if($rows['name'] == 'A') echo 'active';?>"
                                        data-toggle="tab"
                                        href="#<?php echo $rows['name'];?>"><?php echo getPhrase('section');?>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane <?php if($row['name'] == 'A') echo 'active';?>"
                        id="<?php echo $row['name'];?>">
                        <div class="element-wrapper">
                            <div class="element-box table-responsive lined-primary shadow"
                                id="print_area<?php echo $row['section_id'];?>">
                                <div class="row m-b">
                                    <div style="display:inline-block">
                                        <img style="max-height:80px;margin:0px 10px 20px 20px"
                                            src="<?php echo base_url();?>public/uploads/<?php echo $this->crud->getInfo('logo');?>" />
                                    </div>
                                    <div style="padding-left:20px;display:inline-block;">
                                        <h5><?php echo getPhrase('class_routine');?></h5>
                                        <p><?php echo $this->db->get_where('class', array('class_id' => $id))->row()->name;?><br><?php echo getPhrase('section');?>
                                            <?php echo $this->db->get_where('section', array('section_id' => $row['section_id']))->row()->name;?>
                                        </p>
                                    </div>
                                </div>
                                <table class="table table-bordered table-schedule table-hover" cellpadding="0"
                                    ...
                                    <tr>
                                        <table class="table table-schedule table-hover" cellpadding="0" cellspacing="0">
                                            <td width="120" class="bg-primary text-white" height="100"
                                                ...
                                                <strong><?php echo getPhrase($day);?></strong>
                                            </td>
                                            <?php
                                            ...
                                            <td style="text-align:center">
                                                <div class="pi-controls" style="text-align:right;">
                                                    <div class="pi-settings os-dropdown-trigger">
                                                        <i
                                                            class="os-icon picons-thin-icon-thin-0069a_menu_hambuger"></i>
                                                        <div class="os-dropdown">
                                                            ...
                                                            <ul>
                                                                <li>
                                                                    <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_routine/<?php echo $row2['class_routine_id'];?>');"
                                                                ...
                                                                <li>
                                                                    <a onClick="return confirm('<?php echo getPhrase('confirm_delete');?>')"
                                                                        href="<?php echo base_url();?>admin/class_routine/delete/<?php echo $row2['class_routine_id'];?>"><i
                                                                            class="os-icon picons-thin-icon-thin-0056_bin_trash_recycle_delete_garbage_empty"></i><span><?php echo getPhrase('delete');?></span></a>
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </div>
                            ...
                            <button class="btn btn-rounded btn-primary pull-right"
                                onclick="printDiv('print_area<?php echo $row['section_id'];?>')"><?php echo getPhrase('print');?></button><br><br><br>
                        </div>
                    </div>
                    <?php endforeach;?>
                    <?php endif;?>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ui-block-title" style="background-color:#00579c">
                        <h6 class="title" style="color:white"><?php echo getPhrase('add_schedules');?> </h6>
                    </div>
                    <div class="ui-block-content">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group label-floating is-select">
                                    ...
                                    <div class="select">
                                        <select name="section_id" id="section_selector_holder"
                                            onchange="get_class_subject(this.value);" required="">
                                            <option value=""><?php echo getPhrase('select');?></option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group label-floating is-select">
                                    <label class="control-label"><?php echo getPhrase('course');?></label>
                                    <div class="select">
                            ...
                            <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                <div class="form-group label-floating is-select">
                                    <label class="control-label"><?php echo getPhrase('day');?></label>
                                    <div class="select">
                                        <select name="day" required="">
                                            ...
                                            <?php
                                                $days = $this->db->get_where('academic_settings', array('type' => 'routine'))->row()->description; 
                                                if($days == 1):?>
                                            <option value="Sunday"><?php echo getPhrase('sunday');?></option>
                                            <?php endif;?>
                                            <option value="Monday"><?php echo getPhrase('monday');?></option>
                                            <option value="Tuesday"><?php echo getPhrase('tuesday');?></option>
                                            <option value="Wednesday"><?php echo getPhrase('wednesday');?></option>
                                            <option value="Thursday"><?php echo getPhrase('thursday');?></option>
                                            <option value="Friday"><?php echo getPhrase('friday');?></option>
                                            <?php if($days == 1):?>
                                            <option value="Saturday"><?php echo getPhrase('saturday');?></option>
                                            <?php endif;?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <legend><span style="font-size:15px;"><?php echo getPhrase('start');?></span></legend>
                            </div>
                            <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="form-group label-floating is-select">
                                    <label class="control-label"><?php echo getPhrase('hour');?></label>
                                    <div class="select">
                            ...
                            <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="form-group label-floating is-select">
                                    <label class="control-label"><?php echo getPhrase('minutes');?></label>
                                    <div class="select">
                                        <select name="time_start_min" required="">
                                            <option value=""><?php echo getPhrase('select');?></option>
                                            <?php for($i = 0; $i <= 11 ; $i++):?>
                                            <option value="<?php $n = $i * 5; if($n < 10) echo '0'.$n; else echo $n;?>">
                                                <?php $n = $i * 5; if($n < 10) echo '0'.$n; else echo $n;?></option>
                                            <?php endfor;?>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-12">
                                <legend><span style="font-size:15px;"><?php echo getPhrase('end');?></span></legend>
                            </div>
                            <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                                <div class="form-group label-floating is-select">
                                    <label class="control-label"><?php echo getPhrase('hour');?></label>
                        ...
                        <div class="form-buttons-w text-right">
                            <center><button class="btn btn-rounded btn-success btn-lg"
                                    type="submit"><?php echo getPhrase('add');?></button></center>
                        </div>
                        <?php echo form_close();?>
                    </div>
                </div>
