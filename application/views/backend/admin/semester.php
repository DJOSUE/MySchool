            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        ...
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>admin/semesters/"><i
            ...
            <div class="content-i">
                <div class="content-box">
                    <div class="expense"><button class="btn btn-success btn-rounded btn-upper"
                            data-target="#new_semester" data-toggle="modal" type="button">+
                            <?php echo getPhrase('new_semester');?></button></div><br>
                    <div class="element-wrapper">
                        <h6 class="element-header"><?php echo getPhrase('semesters');?></h6>
                        <div class="element-box-tp">
                            <div class="table-responsive">
                                <table class="table table-padded">
                                    ...
                                    <tbody>
                                        <?php $n = 1; $semesters = $this->db->get('semesters')->result_array(); foreach($semesters as $row):?>
                                        <tr>
                                            <td><?php echo $n++;?></td>
                                            <td><span><?php echo $row['name'];?></span></td>
                                            <td class="bolder">
                                                <a onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_semester/<?php echo $row['semester_id'];?>');"
                                                ...
                                                <a class="grey" data-toggle="tooltip" data-placement="top"
                                                    ...
                                                    href="<?php echo base_url();?>admin/semesters/delete/<?php echo $row['semester_id'];?>"><i
                    ...
                    <div class="modal fade" id="new_semester" tabindex="-1" role="dialog" aria-labelledby="new_semester"
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="modal-header" style="background-color:#00579c">
                                        <h6 class="title" style="color:white"><?php echo getPhrase('new_semester');?>
                                        </h6>
                                    </div>
                                    <div class="ui-block-content">
                                        <form action="<?php echo base_url();?>admin/semesters/create"
