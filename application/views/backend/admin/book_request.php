                                    ...
                                    <table class="table table-padded">
                                        ...
                                        <?php
			                                ...
			                                <tr>
                                                ...
                                                <td>
                                                    <?php if($row['status'] == 0) { ?>
                                                        <a data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getPhrase('approve');?>" onClick="return confirm('<?php echo getPhrase('confirm_approval');?>')" href="<?php echo base_url();?>admin/book_request/accept/<?php echo $row['book_request_id'];?>"><i style="color:gray" class="picons-thin-icon-thin-0154_ok_successful_check"></i></a>
                        						        <a data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getPhrase('reject');?>" onClick="return confirm('<?php echo getPhrase('confirm_reject');?>')" href="<?php echo base_url();?>admin/book_request/reject/<?php echo $row['book_request_id'];?>"><i style="color:gray" class="picons-thin-icon-thin-0153_delete_exit_remove_close"></i></a>
                                                    <?php } else echo getPhrase('no_actions'); ?>
                                                </td>
			                                </tr>
			                                <?php } ?>
                                        </tbody>
