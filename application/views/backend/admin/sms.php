            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        <li class="navs-item">
                            <a class="navs-links" href="<?php echo base_url();?>admin/system_settings/"><i class="os-icon picons-thin-icon-thin-0050_settings_panel_equalizer_preferences"></i><span><?php echo getPhrase('system_settings');?></span></a>
                        </li>
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>admin/sms/"><i class="os-icon picons-thin-icon-thin-0287_mobile_message_sms"></i><span><?php echo getPhrase('sms');?></span></a>
                        </li>
                        <li class="navs-item">
										...
										<div class="element-box shadow shadow lined-purple" style="border-radius:10px;">
				        					<div class="col-sm-12">
				        						<div class="form-group label-floating is-select">
                                                    <label class="control-label"><?php echo getPhrase('sms_service');?></label>
                                                    <div class="select">
                                                        <select name="sms_status" onchange="submit();">
                                                            <option value="deactivate" <?php if($status == 'deactivate') echo 'selected';?>><?php echo getPhrase('disabled');?></option>
    		  									...
    		  									<?php echo form_open(base_url() . 'admin/sms/clickatell');?>
                                    				...
                                    				<div class="col-sm-12">
    		   										...
    		   										<div class="form-buttons-w text-right">
                										<button class="btn btn-rounded btn-primary" type="submit"> <?php echo getPhrase('update');?></button>
              										</div>
              									<?php echo form_close();?>
    										</div>
    									</div>
    		      							...
    		      							<div class="element-box shadow lined-danger" style="border-radius:10px;">
    		  									...
    		  									<?php echo form_open(base_url() . 'admin/sms/twilio');?>
            										...
            										<div class="col-sm-12">
       												...
       												<div class="form-buttons-w text-right">
    													<button class="btn btn-rounded btn-danger" type="submit"> <?php echo getPhrase('update');?> </button>
      												</div>
              									<?php echo form_close();?>
    										</div>
    									</div>
                                        ...
                                        <div class="element-box lined-primary shadow" style="border-radius:10px;">
                                            ...
                                            <div class="row">   
                                                <div class="col-sm-6">
								                    ...
								                    <div class="description-toggle">
    									                <div class="description-toggle-content">
										                    <div class="h6"><?php echo getPhrase('students_reports');?></div>
