                                        ...
                                        <div class="top-header top-header-favorit">
                                            ...
                                            <div class="profile-section" style="background-color: #fff;">
                                                ...
                                                <div class="control-block-button">
                                                    <a data-toggle="modal" data-target="#bulkstudents"
                                                        href="javascript:void(0);" class="btn btn-control bg-purple"
                                                        style="background:#0084ff; color: #fff;">
                                                        <i class="picons-thin-icon-thin-0089_upload_file"
                                                            title="<?php echo getPhrase('upload_from_excel');?>"></i>
                                                    </a>
                                                    <a href="javascript:void(0);" data-toggle="modal"
                                                        data-target="#student_export" class="btn btn-control bg-purple"
                                                        style="background:#99bf2d; color: #fff;">
                                                        <i class="picons-thin-icon-thin-0129_download"
                                                            title="<?php echo getPhrase('export_students');?>"></i>
                                                    </a>
                                                </div>
                                                <?php endif;?>
                                            </div>
                                                            ...
                                                            <div class="os-tabs-w">
                                                                <div class="os-tabs-controls">
                                                                    <ul class="navs navs-tabs upper"
                                                                        ...
                                                                        <?php $query = $this->db->get_where('section' , array('class_id' => $class_id, 'year' => $running_year, 'semester_id' => $running_semester)); 
               																if ($query->num_rows() > 0):
                                                        ...
                                                        <div class="tab-content">
                                                            <div class="tab-pane active" id="all">
                                                                <div class="row" id="results">
                                                                    <?php 
																		if($students = $this->db->get_where('enroll' , array('class_id' => $class_id , 'year' => $running_year, 'semester_id' => $running_semester))->num_rows() > 0):
																	?>
                                                                    <?php 
                                                                        ...
                                                                        <div class="card-box widget-user ui-block list">
                                                                            <div class="more" class="pull-right">
                                                                                ...
                                                                                <ul class="more-dropdown">
                                                                                    <li><a href="javascript:void(0);"
                                                                                            onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_student/<?php echo $row['student_id'];?>');"><?php echo getPhrase('edit');?></a>
                                                                                    </li>
                                                                                    <?php if(has_permission('login_as_student')):?>
                                                                                    <li>
                                                                                        <a href="<?php echo base_url();?>admin/login_as/student/<?php echo $row['student_id'];?>/">
                                                                                    ...
                                                                                    <li>
                                                                                        <a onClick="return confirm('<?php echo getPhrase('confirm_delete');?>')"
                                                                                            href="<?php echo base_url();?>admin/delete_student/<?php echo $row['student_id'];?>"><?php echo getPhrase('delete');?></a>
                                                                                    </li>
                                                                                    <?php endif;?>
                                                                                </ul>
                                                                            </div>
                                                                            <div>
                                                                                ...
                                                                                <div class="wid-u-info">
                                                                                    <a href="<?php echo base_url();?>admin/student_portal/<?php echo $row['student_id'];?>/"
                                                                                    ...
                                                                                    <p class="text-muted m-b-5 font-13">
                                                                                        ...
                                                                                        <b><i
                                                                                                class="picons-thin-icon-thin-0729_student_degree_science_university_school_graduate"></i></b>
                                                                                        <span
                                                            ...
                                                            <div class="tab-pane"
                                                                ...
                                                                <div class="row">
                                                                    <?php if($students = $this->db->get_where('enroll' , array('class_id'=> $class_id , 'section_id' => $row['section_id'] , 'year' => $running_year, 'semester_id' => $running_semester))->num_rows() > 0):?>
                                                                    <?php 
                                                                    ...
                                                                    <div class="col-xl-4 col-md-6">
                                                                        <div class="card-box widget-user ui-block list">
                                                                            <div class="more" class="pull-right">
                                                                                ...
                                                                                <ul class="more-dropdown">
                                                                                    <li><a href="javascript:void(0);"
                                                                                            onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_student/<?php echo $row2['student_id'];?>');"><?php echo getPhrase('edit');?></a>
                                                                                    </li>
                                                                                    <li><a onClick="return confirm('<?php echo getPhrase('confirm_delete');?>')"
                                                                                            href="<?php echo base_url();?>admin/delete_student/<?php echo $row2['student_id'];?>"><?php echo getPhrase('delete');?></a>
                                                                                    </li>
                                                                                </ul>
                                                                            </div>
                                                                            <div>
                                                                                <img src="<?php echo $this->crud->get_image_url('student',$row2['student_id']);?>"
                                                                                    ...
                                                                                    alt="user">
                                                                                <div class="wid-u-info">
                                                                                    <a href="<?php echo base_url();?>admin/student_portal/<?php echo $row2['student_id'];?>/"
                                                                                        class="h6 author-name">
                                                                                        <h5 class="mt-0 m-b-5">
...
<div class="modal fade" id="student_export" tabindex="-1" role="dialog" aria-labelledby="student_export"
    ...
    <div class="modal-dialog window-popup edit-widget edit-widget-twitter" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header" style="background-color:#00579c">
                <h6 class="title" style="color:white"><?php echo getPhrase('export_students');?></h6>
            </div>
            <div class="modal-body">
                ...
                <button class="btn btn-rounded btn-purple  btn-icon-left" type="submit"><i
                        class="picons-thin-icon-thin-0129_download"></i> <?php echo getPhrase('export');?></button>
                </center>
                <?php echo form_close();?>
            </div>
        </div>
    ...
    <div class="modal-dialog window-popup create-friend-group create-friend-group-1" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h6 class="title"><?php echo getPhrase('upload_students');?></h6>
            </div>
            <div class="modal-body">
                <div class="form-group label-floating is-select">
                    <label class="control-label"><?php echo getPhrase('class');?></label>
                ...
                <div class="form-group with-button">
                    <a href="<?php echo base_url();?>public/uploads/templates/students.xlsx"><input
                            class="form-control " readonly value="<?php echo getPhrase('download_template');?>"
                ...
                <button type="submit"
                    class="btn btn-rounded btn-success btn-lg full-width"><?php echo getPhrase('upload');?></button>
            </div>
            <?php echo form_close();?>
        </div>
    </div>
