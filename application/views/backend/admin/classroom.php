												...
												<div class="top-header-thumb">
													...
													<div class="top-header-author">
														...
														<div class="author-content">
															<a href="javascript:void(0);" class="h3 author-name"><?php echo getPhrase('calassrooms');?></a>
												...
												<div class="profile-section" style="background-color: #fff;">
													<div class="control-block-button">
                            							 <a href="javascript:void(0);" class="btn btn-control bg-purple" style="background:#99bf2d; color: #fff;" data-toggle="modal" data-target="#crearadmin">
															<i class="picons-thin-icon-thin-0001_compose_write_pencil_new" style="font-size:25px;" title="<?php echo getPhrase('add');?>"></i>
			                                                        ...
			                                                        <div class="ui-block list">
				                                                        ...
				                                                        <div class="birthday-item inline-items">
					                                                        ...
					                                                        <div class="birthday-author-name">
						                                                        ...
						                                                        <div><b><?php echo getPhrase('students');?>:</b> <?php $this->db->where('dormitory_id', $room['dormitory_id']); echo $this->db->count_all_results('student');?>.</div>
					                                                        </div>
				                                                        </div>
			                                                        </div>
		                                                        </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="modal-header" style="background-color:#00579c">
                        <h6 class="title" style="color:white"><?php echo getPhrase('add');?></h6>
                    </div>
