												...
												<div class="top-header-thumb">
													...
													<div class="top-header-author">
														...
														<div class="author-content">
															<a href="javascript:void(0);" class="h3 author-name"><?php echo getPhrase('polls');?></a>
												...
												<div class="profile-section" style="background-color: #fff;">
													<div class="control-block-button">
                            							<a href="<?php echo base_url();?>admin/new_poll/" class="btn btn-control bg-purple" style="background:#0084ff; color: #fff;">
                                                            <i class="icon-feather-plus" title="<?php echo getPhrase('new_poll');?>"></i>
				                                                ...
				                                                <ul class="table-careers">
				                                                    ...
				                                                    ?>
					                                                    <li class="ui-block lists">
					                                                        ...
					                                                        <strong class="btnss successs pull-right" style="margin-top:-65px; margin-right:-10px; font-size:15px; border-radius:25px; padding:7px; box-shadow: 0 2px 30px 0 rgba(153, 191, 45, 0.20);"><?php $this->db->where('poll_code', $poll['poll_code']); echo $this->db->count_all_results('poll_response');?> <?php echo getPhrase('votes');?></strong>
						                                                    <a href="<?php echo base_url();?>admin/view_poll/<?php echo $poll['poll_code'];?>/"><h3><span class="bold"><?php echo $poll['question'];?></span></h3></a>
						                                                    <a onClick="return confirm('<?php echo getPhrase('confirm_delete');?>')" href="<?php echo base_url();?>admin/polls/delete2/<?php echo $poll['poll_code'];?>"><i style="font-size:18px;" class="picons-thin-icon-thin-0057_bin_trash_recycle_delete_garbage_full"></i></a>
					                                                    </li>
					                                               <?php endforeach;?>
				                                                </ul>
			                                                </div>
