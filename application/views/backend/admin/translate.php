            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        ...
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>admin/translate/"><i class="os-icon picons-thin-icon-thin-0307_chat_discussion_yes_no_pro_contra_conversation"></i><span><?php echo getPhrase('translate');?></span></a>
                        </li>
                        <li class="navs-item">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="element-box shadow shadow lined-primary" style="border-radius:10px;">
                                <button class="btn btn-rounded btn-success" data-toggle="modal" data-target="#addlang"><?php echo getPhrase('add_language');?></button><hr>
                                            ...
                                            <div class="chat-content min">
                                                ...
                                                ?>
                                                    <div class="user-w">
                                                        ...
                                                        <a class="btn btn-rounded  btn-primary" href="<?php echo base_url();?>admin/translate/update/<?php echo $data[$i];?>"><i class="picons-thin-icon-thin-0307_chat_discussion_yes_no_pro_contra_conversation"></i> <?php echo getPhrase('update');?></a>
                                                    </div>
                                                <?php endfor;?>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog window-popup edit-widget edit-widget-twitter" role="document">
            <div class="modal-content">
                <div class="modal-header" style="background-color:#00579c">
                    <h6 class="title" style="color:white"><?php echo getPhrase('add_language');?></h6>
                ...
                <div class="modal-body">
                    <?php echo form_open(base_url() . 'admin/translate/add/', array('enctype' => 'multipart/form-data')); ?>
                        ...
                        <div class="form-group">
                            <label class="control-label"><?php echo getPhrase('flag');?></label>
                            <input class="form-control" name="file_name" type="file">
                        </div>
                        <button class="btn btn-rounded btn-purple  btn-icon-left" type="submit"><?php echo getPhrase('save');?></button></center>
                    <?php echo form_close();?>
                </div>
            </div>
        </div>
