            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        ...
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>admin/database/"><i class="picons-thin-icon-thin-0356_database"></i><span><?php echo getPhrase('database');?></span></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="content-i">
                <div class="content-box">
                    <div class="element-box lined-purple shadow" style="border-radius:10px;">
                        <h4 class="form-header"><i class="picons-thin-icon-thin-0356_database"></i> <?php echo getPhrase('backup_restore');?></h4><br>
                        <div class="row">
                            <div class="col-sm-6">
                                        ...
                                        <div class="friend-item-content">
                                            <div class="friend-avatar">
                                                ...
                                                <div class="author-content">
                                                    <a href="<?php echo base_url();?>admin/database/create/" class="h5 author-name"><?php echo getPhrase('generate_backup');?></a>
                                                </div>
                                            </div>
                                        ...
                                        <div class="friend-item-content">
                              	            <?php echo form_open(base_url() . 'admin/database/restore', array('enctype' => 'multipart/form-data'));?>
                                                <div class="friend-avatar">
                                                    ...
                                                    <div class="author-content">
                                                        <a href="javascript:void(0);" class="h5 author-name"><?php echo getPhrase('import_backup');?></a>
                                                    </div>
                                                </div>
                                                <div class="control-block-button">
