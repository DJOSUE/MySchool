                                ...
                                <div class="step-content active" id="stepContent0">
                                    ...
                                    <div class="form-buttons-w text-right">
                                        <a class="btn btn-rounded btn-success btn-lg step-trigger-btn"
                                            href="#stepContent1"  onclick="get_level()"><?php echo getPhrase('next');?></a>
                                    </div>
                                </div>
                                <div class="step-content" id="stepContent1">
									<div class="row div-center text-center">
                                    <div class="info-box" style="background-color: #f2f4f8; color:#000">
                                        <p>
                                            <?= getPhrase('suggested_level')?>: <br/>
                                            <span id="suggested_level" class="h5"><?= getPhrase('enter_score_placement_test')?></span>
                                        </p>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group label-floating">
                                                ...
                                                <input class="form-control" name="username" autocomplete="false"
                                                    required="" type="text" id="user_student">
                                ...
                                <div class="step-content" id="stepContent2">
                                        ...
                                        <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="description-toggle">
                                                <div class="description-toggle-content">
                                                    <div class="h6"><?php echo getPhrase('new_parent_admission');?>
                                                    </div>
                                                    <p><?php echo getPhrase('new_parent_admission_message');?></p>
                                                </div>
                                    ...
                                    <div class="row" id="new_parent">
                                        <div class="ui-block-title" style="margin-bottom:10px;">
                                            <h6 class="title"><?php echo getPhrase('parent_details');?></h6>
                                        </div>
                                        <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group label-floating">
                                                <label
                                        ...
                                        <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group label-floating">
                                                <label class="control-label"><?php echo getPhrase('email');?></label>
                                                <input class="form-control" name="parent_email" id="parent_email"
                                                    type="email">
                                        ...
                                        <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group label-floating">
                                                <label class="control-label"><?php echo getPhrase('username');?></label>
                                                <input class="form-control" name="parent_username" autocomplete="false"
                                                    type="text" id="parent_username">
                                        ...
                                        <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="form-group label-floating">
                                                <label class="control-label"><?php echo getPhrase('password');?></label>
                                                <input class="form-control" name="parent_password" autocomplete="false"
                                                    type="password">
                                            </div>
                                        </div>
                                        <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                ...
                                <div class="step-content" id="stepContent3">
                                    <div class="row">
                                        ...
                                        <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                            <div class="description-toggle">
                                                <div class="description-toggle-content">
                                                    <div class="h6"><?php echo getPhrase('download_adminssion_sheet');?>
                                                    </div>
                                                    <p><?php echo getPhrase('download_adminssion_sheet_message');?></p>
                                                </div>
                                                <div class="togglebutton">
