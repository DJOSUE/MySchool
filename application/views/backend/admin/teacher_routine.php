            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        <li class="navs-item">
                            <a class="navs-links" href="<?php echo base_url();?>admin/class_routine_view/"><i class="os-icon picons-thin-icon-thin-0024_calendar_month_day_planner_events"></i><span><?php echo getPhrase('class_routine');?></span></a>
                        </li>
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>admin/teacher_routine/"><i class="os-icon picons-thin-icon-thin-0011_reading_glasses"></i><span><?php echo getPhrase('teacher_routine');?></span></a>
                        </li>
                    </ul>     
                </div>
            </div>
                ...
                <?php if($teacher_id > 0):?>
                    <div class="element-wrapper">
                        <div class="element-box table-responsive lined-primary shadow" id="print_area">
                            <div>
                                <center> 
                                    <h5><?php echo getPhrase('teacher_routine');?></h5>
                            ...
                            ?>
                                <tr>
                                    <table class="table table-schedule table-hover" cellpadding="0" cellspacing="0">
                                        <td width="120" class="bg-primary text-white" height="90" style="text-align: center;"><strong><?php echo ucwords(getPhrase($day));?></strong></td>
                                        <?php
                        ...
                        <button class="btn btn-rounded btn-primary pull-right" onclick="printDiv('print_area')" ><?php echo getPhrase('print');?></button><br><br><br>
                    </div>  
                <?php endif;?>
                </div>      
            </div>
