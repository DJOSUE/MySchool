        ...
        <div class="content-box">
            <div class="conty">
                <div class="back" style="margin-top:-20px;margin-bottom:10px">
                    <a title="<?php echo getPhrase('return');?>" href="<?php echo base_url();?>admin/teachers/"><i
                                ...
                                <div class="user-profile">
                                    ...
                                    <div class="ui-block">
                                        <div class="ui-block-title">
                                            <h6 class="title"><?php echo getPhrase('teacher_schedules');?></h6>
                                        </div>
                                        <div class="ui-block-content">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-schedule table-hover"
			                                        ...
			                                        ?>
                                                    <tr>
                                                        <table class="table table-schedule table-hover table-bordered"
                                                            cellpadding="0" cellspacing="0">
                                                            <td class="bg-primary text-white" width="120" height="100%"
                                                                style="text-align: center; border:none;">
                                                                <strong><?php echo getPhrase($day);?></strong></td>
                                                            <?php
                                                            ...
                                                            <td style="text-align:center">
                                                                <?php
                                                                    ...
                                                                    ?><br><b><?php echo $this->crud->get_subject_name_by_id($row2['subject_id']);?></b><br><small><?php echo $this->db->get_where('class', array('class_id' => $row2['class_id']))->row()->name;?>
                                                                    -
                                                                    <strong><?php echo $this->db->get_where('section', array('section_id' => $row2['section_id']))->row()->name;?></strong></small>
                                                            </td>
                                                            <?php endforeach;?>
                                                        </table>
                                                    </tr>
                                        ...
                                        <div class="help-support-block">
                                            ...
                                            <ul class="help-support-list">
                                                <li>
                                                    ...
                                                    <a
                                                        href="<?php echo base_url();?>admin/teacher_profile/<?php echo $teacher_id;?>/"><?php echo getPhrase('personal_information');?></a>
                                                </li>
												<?php if(has_permission('can_edit_teacher')): ?>
                                                <li>
                                                    <i class="picons-thin-icon-thin-0133_arrow_right_next"
                                                        style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
                                                    <a
                                                        href="<?php echo base_url();?>admin/teacher_update/<?php echo $teacher_id;?>/"><?php echo getPhrase('update_information');?></a>
                                                </li>
												<?php endif;?>
                                                <li>
                                                    <i class="picons-thin-icon-thin-0133_arrow_right_next"
                                                        style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
                                                    <a
                                                        href="<?php echo base_url();?>admin/teacher_schedules/<?php echo $teacher_id;?>/"><?php echo getPhrase('schedules');?></a>
                                                </li>
                                                <li>
                                                    <i class="picons-thin-icon-thin-0133_arrow_right_next"
                                                        style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
                                                    <a
                                                        href="<?php echo base_url();?>admin/teacher_subjects/<?php echo $teacher_id;?>/"><?php echo getPhrase('subjects');?></a>
                                                </li>
                                                ...
                                                <li>
                                                    <i class="picons-thin-icon-thin-0329_computer_laptop_user_login"
                                                        style="font-size:20px"></i> &nbsp;&nbsp;&nbsp;
                                                    <a
                                                        href="<?php echo base_url();?>admin/login_as/teacher/<?php echo $teacher_id;?>/"><?php echo getPhrase('login_as');?></a>
                                                </li>
                                                <?php endif;?>
                                            </ul>
                                        </div>
