                                ...
                                <div class="post__author author vcard inline-items">
                                    ...
                                    <div class="author-date">
                                        <a class="h6 post__author-name fn"
                                            ...
                                            <small>(<?php echo $this->db->get_where('units', array('unit_id' => $exam_id))->row()->name;?>)</small>.</a>
                                    </div>
                                </div>
                                        ...
                                        <div id='cssmenu'>
                                            <ul>
                                                <?php  
                            				            ...
                            				            $var++;
                            				        ?>
                                                <li class='<?php if($exam['unit_id'] == $exam_id) echo "act";?>'><a
                                                        href="<?php echo base_url();?>admin/upload_marks/<?php echo $data.'/'.$exam['unit_id'];?>/"><i
                                                            class="os-icon picons-thin-icon-thin-0023_calendar_month_day_planner_events"></i><?php echo $exam['name'];?></a>
                                                </li>
                                                <?php endforeach;?>
                                            </ul>
                                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php
                                                            $count = 1;
                                                            $marks_of_students = $this->db->get_where('mark' , array('class_id' => $ex[0], 'section_id' => $ex[1] ,'year' => $running_year,'subject_id' => $ex[2],'unit_id' => $exam_id))->result_array();
                                                ...
                                                <tr style="height:25px;">
                                                    ...
                                                    <td class="text-center">
                                                        <center><input type="text"
                                                                name="marks_obtained_<?php echo $row['mark_id'];?>"
                                                                placeholder="0"
                                                                style="width:55px; border: 1; text-align: center;"
                                                                value="<?php echo $row['mark_obtained'];?>"> </center>
                                                    </td>
                                                    <td>
                                                        <center><input type="text"
