					        ...
					        <div class="element-wrapper">
	  						    <div class="element-box lined-primary shadow">
							        <?php echo form_open(base_url() . 'admin/polls/create_wall/' , array('enctype' => 'multipart/form-data'));?>
    		  					        <h5 class="form-header"><?php echo getPhrase('create_poll');?></h5><br>
		  					            <div class="form-group">
			  					            <div class="col-sm-12">
			  						            <label class="col-form-label" for="" style="text-align: left;"><?php echo getPhrase('question');?></label>
			  						            <div class="input-group">
										            <div class="input-group-addon">
    											        <i class="picons-thin-icon-thin-0382_graph_columns_statistics"></i>
				  						            </div>
    										        <input class="form-control" placeholder="<?php echo getPhrase('question');?>" name="question" required="" type="text">
									            </div>
    			  					        </div>
							            </div>
							            <div id="bulk_add_form">
      							            <div id="student_entry">
									            <div class="form-group">
			  							            <div class="col-sm-12">
			  								            <label class="col-form-label" for=""><?php echo getPhrase('options');?></label>
			  									        <div class="input-group">
													        <input class="form-control" name="options[]" placeholder="<?php echo getPhrase('options');?>" required="" type="text">
          					            ...
          					            <center><a href="javascript:void(0);" class="btn btn-rounded btn-success btn-sm" onclick="append_student_entry()">+ <?php echo getPhrase('more_options');?></a></center>							<br>
							            <div class="form-group">
				            	            <div class="col-sm-12">
            						            <div class="form-group label-floating is-select">
                                                    <label class="control-label"><?php echo getPhrase('users');?></label>
                                                    <div class="select">
                                                        <select name="user" id="slct">
                                                            <option value=""><?php echo getPhrase('select');?></option>
                                                            <option value="all"><?php echo getPhrase('all');?></option>
		  					            ...
		  					            <div class="form-buttons-w">
								            <button class="btn btn-primary btn-rounded" type="submit"> <?php echo getPhrase('save');?></button>
		  					            </div>
						            <?php echo form_close();?>
		  			            </div>
				            </div>
