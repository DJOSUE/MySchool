...
?>
    <div class="modal-body">
        <div class="ui-block-title" style="background-color:#00579c">
            <h6 class="title" style="color:white"><?php echo getPhrase('update_routine');?></h6>
        </div>
        <div class="ui-block-content">
            <?php echo form_open(base_url() . 'admin/class_routine/update/'.$row['class_routine_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                <div class="row">
                        ...
                        <div class="form-group label-floating is-select">
                            ...
                            <div class="select">
                                <select name="day" required="">
                                    ...
                                    if($days == 1):?>
                                        <option value="Sunday" <?php if($row['day']== "Sunday") echo "selected";?>><?php echo getPhrase('sunday');?></option>
                                    <?php endif;?>
                                    <option value="Monday" <?php if($row['day']== "Monday") echo "selected";?>><?php echo getPhrase('monday');?></option>
                                    <option value="Tuesday" <?php if($row['day']== "Tuesday") echo "selected";?>><?php echo getPhrase('tuesday');?></option>
                                    <option value="Wednesday" <?php if($row['day']== "Wednesday") echo "selected";?>><?php echo getPhrase('wednesday');?></option>
                                    <option value="Thursday" <?php if($row['day']== "Thursday") echo "selected";?>><?php echo getPhrase('thursday');?></option>
                                    <option value="Friday" <?php if($row['day']== "Friday") echo "selected";?>><?php echo getPhrase('friday');?></option>
                                    <?php if($days == 1):?>
                                        <option value="Saturday" <?php if($row['day']== "Saturday") echo "selected";?>><?php echo getPhrase('saturday');?></option>
                                    <?php endif;?>
                                </select>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-12"><legend><span style="font-size:15px;"><?php echo getPhrase('start');?></span></legend></div>
                    ...
                    ?>
                    <div class="col-sm-12"><legend><span style="font-size:15px;"><?php echo getPhrase('end');?></span></legend></div>
                    <div class="col col-lg-4 col-md-4 col-sm-12 col-12">
                        <div class="form-group label-floating is-select">
                            <label class="control-label"><?php echo getPhrase('hour');?></label>
                            <div class="select">
                ...
                <div class="form-buttons-w text-right">
                    <center><button class="btn btn-rounded btn-success" type="submit"><?php echo getPhrase('update');?></button></center>
                </div>
            <?php echo form_close();?>        
        </div>
    </div>
