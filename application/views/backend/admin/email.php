            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        ...
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>admin/email/"><i class="os-icon picons-thin-icon-thin-0315_email_mail_post_send"></i><span><?php echo getPhrase('email_settings');?></span></a>
                        </li>
                        <li class="navs-item">
                            ...
                            <div class="col-sm-12">
                                <div class="os-tabs-w">
                                    <div class="os-tabs-controls">
                                        ...
                                        ?>
                                            <li class="navs-item">
                                                <a class="navs-link <?php if ($row['email_template_id'] == $current_email_template_id) echo 'active';?>" data-toggle="tab" href="#email<?php echo $row['email_template_id'];?>"> <b>[</b><?php echo getPhrase($row['task']);?><b>]</b></a>
                                            </li>
                                        <?php endforeach;?>
                                        </ul>
                                    </div>
