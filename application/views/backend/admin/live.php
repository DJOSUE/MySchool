                            ...
                            <div class="features-video-content">
                                <article class="hentry post">
                                    <div class="post__author author vcard inline-items">
                                        <img src="<?php echo $this->crud->get_image_url($row['user_type'], $row['user_id']);?>"
                                            width="36" height="36" alt="author">
                                        <div class="author-date">
                                            <a class="h6 post__author-name fn"
                                                href="javascript:void(0);"><?php echo $this->crud->get_name($row['user_type'], $row['user_id']);?></a>
                                            <div class="post__date">
                                                <time class="published"
                                                    datetime="2017-03-24T18:18"><?php echo $row['publish_date'];?></time>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <hr>
                                    <b><?php echo getPhrase('participants');?>:</b>
                                    <ul class="friends-harmonic">
                                        ...
                                        <li>
                                            <a href="javascript:void(0);" style="margin-left:0px">
                                                <img title="<?php echo $this->crud->get_name('student', $row2['student_id']);?>"
                                                    src="<?php echo $this->crud->get_image_url('student', $row2['student_id']);?>"
                                                    alt="<?php echo $this->crud->get_name('student', $row2['student_id']);?>"
                                                    width="28" height="28">
                                            </a>
                                        </li>
                                        <?php endforeach;?>
                                    ...
                                    <div style="max-height:400px;overflow-y:auto;">
                                        <b><?php echo getPhrase('your_other_live_classes');?>:</b><br><br>
                                        <?php
                                        ...
                                        <div class="ui-block">
                                            <div class="birthday-item inline-items badges">
                                                <div class="birthday-author-name">
                                                    <a href="<?php echo base_url();?>admin/live/<?php echo base64_encode($rowx['live_id']);?>"
                                                        class="h6 author-name"><?php echo $rowx['title'];?> - <span
                                                            class="badge badge-success"><?php echo $this->db->get_where('subject', array('subject_id' => $rowx['subject_id']))->row()->name;?></span>
                                                        <small>[<?php echo $row['date'];?>].</small></a>
...
var options = {
    userInfo: {
        email: '<?php echo $this->db->get_where('admin', array('admin_id' => get_login_user_id()))->row()->email;?>',
        displayName: '<?php echo $this->crud->get_name('admin', get_login_user_id());?>',
        moderator: true,
    },
