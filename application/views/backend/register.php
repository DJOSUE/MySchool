...
<html>
  <head>
    <title><?php echo getPhrase('create_account');?> | <?php echo $title;?></title>
    <meta charset="utf-8">
                    ...
                    <div class="os-tabs-w">
                        <div class="os-tabs-controls">
                            <ul class="navs navs-tabs upper centered">
                                <li class="navs-item">
                                    <a class="navs-links active text-center" style="" data-toggle="tab" href="#teachers"><i class="picons-thin-icon-thin-0704_users_profile_group_couple_man_woman"></i><span><?php echo getPhrase('teacher');?></span></a>
                                </li>
                                <li class="navs-item">
                                    <a class="navs-links text-center" data-toggle="tab" href="#students"><i class="picons-thin-icon-thin-0729_student_degree_science_university_school_graduate"></i><span><?php echo getPhrase('student');?></span></a>
                                </li>
                                <li class="navs-item">
                                    <a class="navs-links text-center" data-toggle="tab" href="#parents"><i class="picons-thin-icon-thin-0703_users_profile_group_two"></i><span><?php echo getPhrase('parent');?></span></a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('first_name');?>" name="first_name" required="" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('last_name');?>" name="last_name" required="" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('username');?>" required=""  id="username" name="username" type="text">
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('phone');?>" required="" name="phone" type="number">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="form-check">
                                                <label class="form-check-label"><input checked="" class="form-check-input" name="sex" type="radio" value="M"><?php echo getPhrase('male');?></label>
                                                <label class="form-check-label"><input class="form-check-input" name="sex" type="radio" value="F" style="margin-left:5px;"><?php echo getPhrase('female');?></label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('password');?>" name="password" type="password">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="buttons-w">
                                        <input class="btn btn-rounded btn-primary" id="sub_teacher" type="submit" value="<?php echo getPhrase('create_account');?>">
                                    </div>
                                <?php echo form_close();?>
                            </div>
                        </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('fist_name');?>" name="first_name" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('last_name');?>" name="last_name" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('username');?>" id="user2" name="username" type="text">
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('roll');?>" name="roll" type="text" required="">
                                            </div>
                                        </div>
                                   </div>
                                   <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('phone');?>" name="phone" type="number">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('password');?>" name="password" required type="password">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="buttons-w">
                                        <input class="btn btn-rounded btn-primary" id="sub_student" type="submit" value="<?php echo getPhrase('create_account');?>">
                                    </div>
                                <?php echo form_close();?>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="element-wrapper">
                                <?php echo form_open(base_url() . 'register/create_account/parent/' , array('enctype' => 'multipart/form-data'));?>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('first_name');?>" required name="first_name" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('last_name');?>" required name="last_name" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('username');?>" id="user5" required="" name="username" type="text">
                                            </div>
                                        ...
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                               <div class="input-group-addon">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('phone');?>" name="phone" type="phone">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-12">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control" placeholder="<?php echo getPhrase('profession');?>" name="profession" type="text">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                    ...
                                    <div class="buttons-w">
                                        <input class="btn btn-rounded btn-primary" id="sub_parent" type="submit" value="<?php echo getPhrase('create_account');?>">
                                    </div>
                                <?php echo form_close();?>
                            </div>
                        </div>
