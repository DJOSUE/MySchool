...
<html>
  ...
  <head>
    <title><?php echo getPhrase('terms_conditions');?> | <?php echo $this->crud->getInfo('system_title');?></title>
    <meta charset="utf-8">
            ...
            <div class="steps-w">
                <div class="step-contents">
                    <div class="step-content active" id="stepContent1">
                        <h4><?php echo getPhrase('terms_conditions');?></h4><hr>
                        <div class="row">
                            <br>
                            <p><?php echo $this->db->get_where('academic_settings' , array('type' =>'terms'))->row()->description;?></p>
                            <hr>
                            <div class="pull-right"><br><br><br>
                                <a class="btn btn-purple btn-rounded text-white" href="<?php echo base_url();?>"> <?php echo getPhrase('return');?></a>
                            <br><br>
                            </div>
                        </div>
                    </div>
