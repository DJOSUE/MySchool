    <div class="full-chat-middle">
        <div class="chat-head">
            ...
            <div class="user-info">
                ...
                <a class="btn btn-success btn-sm" href="javascript:void(0);" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/group_info/<?php echo $current_message_thread_code;?>');"><?php echo getPhrase('group_members');?></a>
            </div>
        </div> 
        ...
        <div class="chat-info-section">
            ...
            <div class="ci-content  mCustomScrollbar">
                ...
                ?>
				    ...
				    <?php else:?>
					<span><?php echo getPhrase('without_shared_picture');?></span>
				    <?php endif;?>
                </div>
            </div>
        </div>
