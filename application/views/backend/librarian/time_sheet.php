        ...
        <div class="os-tabs-w menu-shad">
            <div class="os-tabs-controls">
                <ul class="navs navs-tabs">
                    <li class="navs-item">
                        <a class="navs-links" href="<?php echo base_url();?>librarian/time_card/"><i class="picons-thin-icon-thin-0844_stopwatch_training_time"></i> <span><?php echo getPhrase('time_card');?></span></a>
                    </li>
                    <li class="navs-item">
                        <a class="navs-links <?php if($page_name == 'time_sheet') echo "active";?>" href="<?php echo base_url();?>librarian/time_sheet/"><i class="picons-thin-icon-thin-0023_calendar_month_day_planner_events"></i>  <span><?php echo getPhrase('time_sheet');?></span></a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="content-box">                
                <div class="col-sm">
                    <div class="element-box lined-primary shadow" style="padding-left: 50px;">
                        <!-- Dropdown Period -->
                        <?php echo form_open(base_url() . 'librarian/time_sheet/', array('class' => 'form m-b'));?>
                        <div class="row sm">
