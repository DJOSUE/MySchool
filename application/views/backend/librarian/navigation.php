            ...
            <div class="mCustomScrollbar" data-mcs-theme="dark">
                <ul class="left-menu">
                    ...
                    <li <?php if($page_name == 'panel'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>librarian/panel/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('dashboard');?>">
                    ...
                    <li <?php if($page_name == 'time_card' || $page_name == 'time_sheet'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>librarian/time_card/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('time_card');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'message' || $page_name == 'group'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>librarian/message/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('messages');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'news'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>librarian/news/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('news');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'library' || $page_name == 'book_request'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>librarian/library/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('library');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'calendar'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>librarian/calendar/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('calendar');?>">
                            <div class="left-menu-icon">
