                                                ...
                                                <div class="top-header-thumb">
                                                    ...
                                                    <div class="top-header-author">
                                                        ...
                                                        <div class="author-content">
                                                            <a href="javascript:void(0);" class="h3 author-name"><?php echo getPhrase('academic');?></a>
                                                                                ...
                                                                                <div class="friend-item-content">         
                                                                                    <div class="more">
                                                                                        ...
                                                                                        <ul class="more-dropdown">
                                                                                            <li><a href="<?php echo base_url();?>parents/subject_dashboard/<?php echo base64_encode($class_id."-".$section_id."-".$row2['subject_id']);?>/"><?php echo getPhrase('dashoard');?></a></li>
                                                                                        </ul>
                                                                                    </div>
