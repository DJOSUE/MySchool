            ...
            <div class="mCustomScrollbar" data-mcs-theme="dark">
                <ul class="left-menu">
                    ...
                    <li <?php if($page_name == 'panel'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>parents/panel/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('dashboard');?>">
                    ...
                    <li <?php if($page_name == 'message' || $page_name == 'group'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>parents/message/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('messages');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'teachers'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>parents/teachers/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('teachers');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'class_routine'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>parents/class_routine/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('class_routine');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'library'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>parents/library/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('library');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'marks'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>parents/marks/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('marks');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'attendance_report' || $page_name == 'subjects' || $page_name == 'forum_room' || $page_name == 'subject_marks' || $page_name == 'study_material' || $page_name == 'forum' || $page_name == 'subject_dashboard' || $page_name == 'homework' || $page_name == 'online_exams'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>parents/subjects/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('academic');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'request'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>parents/request/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('permissions');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'student_report' || $page_name == 'view_report'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>parents/student_report/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('behavior');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'noticeboard'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>parents/noticeboard/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('news');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'calendar'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>parents/calendar/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('calendar');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'invoice'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>parents/invoice/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('payments');?>">
                            <div class="left-menu-icon">
