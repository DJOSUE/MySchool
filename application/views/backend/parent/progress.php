                                                    ...
                                                    <?php foreach($arrs as $row): ?>
                                                        <li class="draggable-task <?php echo $this->crud->check_li_status($row['wall_type'],$row['homework_id'],$row2['student_id']);?>">
                                                            ...
                                                            <?php if($row['wall_type'] == 'exam'):?>
                                                                ...
                                                                ?>
                                                                <span data-container="body" data-content="<i class='picons-thin-icon-thin-0021_calendar_month_day_planner'></i> <?php echo date('d/m/Y', $row['date_end']);?>. <br><i class='picons-thin-icon-thin-0025_alarm_clock_ringer_time_morning'></i> <?php echo $row['time_end'];?>.<br><a style='margin-top:10px;color:#fff' class='badge badge-primary' href='<?php echo base_url();?>parents/online_exams/<?php echo $redirect;?>/' target='_blank'><?php echo getPhrase('go_to_details');?></a>" data-placement="top" data-toggle="popover" title="" data-html="true" data-original-title="<?php echo $row['title'];?>"><i class="os-icon picons-thin-icon-thin-0207_list_checkbox_todo_done" title="<?php echo getPhrase('online_exam');?>"></i>  <?php echo $row['title'];?>. (<b><?php echo $subject_name;?></b>)</span>
                                                            <?php elseif($row['wall_type'] == 'homework'):?>
                                                                <?php 
                                                                    ...
                                                                    $subject_name = $this->db->get_where('subject', array('subject_id' => $subject_id))->row()->name;
                                                                ?>
                                                                <span data-container="body" data-content="<i class='picons-thin-icon-thin-0021_calendar_month_day_planner'></i> <?php echo $row['date_end'];?>.<br><i class='picons-thin-icon-thin-0025_alarm_clock_ringer_time_morning'></i> <?php echo $row['time_end'];?>.<br><a style='margin-top:10px;color:#fff' class='badge badge-primary' href='<?php echo base_url();?>parents/homeworkroom/<?php echo $redirect;?>/' target='_blank'><?php echo getPhrase('go_to_details');?></a>" data-placement="top" data-toggle="popover" title="" data-html="true" data-original-title="<?php echo $row['title'];?>"><i class="os-icon picons-thin-icon-thin-0004_pencil_ruler_drawing" title="<?php echo getPhrase('homework');?>"></i>  <?php echo $row['title'];?>. (<b><?php echo $subject_name;?></b>)</span>
                                                            <?php elseif($row['wall_type'] == 'forum'):?>
                                                                <?php 
                                                                    ...
                                                                    $subject_name = $this->db->get_where('subject', array('subject_id' => $subject_id))->row()->name;
                                                                ?>
                                                                <span data-container="body" data-content="<i class='picons-thin-icon-thin-0021_calendar_month_day_planner'></i> <?php echo $row['time_end'];?>.<br><a style='margin-top:10px;color:#fff' class='badge badge-primary' href='<?php echo base_url();?>parents/forumroom/<?php echo $redirect;?>/' target='_blank'><?php echo getPhrase('go_to_details');?></a>" data-placement="top" data-toggle="popover" title="" data-html="true" data-original-title="<?php echo $row['title'];?>"><i class="os-icon picons-thin-icon-thin-0281_chat_message_discussion_bubble_reply_conversation" title="<?php echo getPhrase('forum');?>"></i>  <?php echo $row['title'];?>. (<b><?php echo $subject_name;?></b>)</span>
