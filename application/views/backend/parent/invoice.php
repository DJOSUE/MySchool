        	            ...
        	            <?php $active = $n++;?>
	 		            <div class="tab-pane <?php if($active == 1) echo 'active';?>" id="<?php echo $row3['username'];?>">
                            <div class="element-wrapper">
                                <h6 class="element-header"><?php echo getPhrase('invoices');?></h6>
                                        ...
                                        <table class="table table-padded">
                                            ...
                                            ?>
				                                <tr>
					                                ...
					                                <td><a class="btn btn-rounded btn-primary" style="color:white" href="<?php echo base_url();?>parents/view_invoice/<?php echo $row2['invoice_id'];?>"><i class="picons-thin-icon-thin-0406_money_dollar_euro_currency_exchange_cash"></i> <?php echo getPhrase('invoice');?></a></td>
					                                <td>
