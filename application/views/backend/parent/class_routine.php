            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>parents/class_routine/"><i class="os-icon picons-thin-icon-thin-0024_calendar_month_day_planner_events"></i><span><?php echo getPhrase('class_routine');?></span></a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <?php $active = $n++;?>
                        <div class="tab-pane <?php if($active == 1) echo 'active';?>" id="<?php echo $row2['username'];?>">
                            <div class="element-wrapper">
                                <div class="element-box table-responsive lined-primary shadow" id="print_area<?php echo $row2['student_id'];?>">
                                    <div class="row m-b">
                                        ...
                                        <div style="padding-left:20px;display:inline-block;">
                                            ...
                                            <p><?php echo getPhrase('class_routine');?></p>
                                        </div>    
                                    </div>
                                    ...
                                    ?>
                                        <tr>
                                            <table class="table table-schedule table-hover" cellpadding="0" cellspacing="0">
                                                <td width="120" class="bg-primary text-white" height="100"><?php echo getPhrase($day);?></td>
                                                <?php
                                                ...
                                                <td style="text-align:center">
                                                    <?php echo '<b>'.getPhrase('classroom').'</b>: '.$this->db->get_where('class_room', array('classroom_id' => $row5['classroom_id']))->row()->name.'.<br>'.$row5['time_start'].":".$row5['time_start_min']." " ."<b>".$row5['amstart']."</b>". ' - ' . $row5['time_end'].":".$row5['time_end_min']." "."<b>".$row5['amend']."</b>";?>
                                ...
                                <button class="btn btn-rounded btn-success pull-right" onclick="printDiv('print_area<?php echo $row2['student_id'];?>')" ><?php echo getPhrase('print');?></button><br><br><br>
                            </div>
                        </div>  
                    <?php endforeach;?>
                    </div>
