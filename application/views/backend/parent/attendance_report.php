            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        ...
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>parents/attendance_report/<?php echo $data;?>/"><i class="os-icon picons-thin-icon-thin-0023_calendar_month_day_planner_events"></i><span><?php echo getPhrase('attendance');?></span></a>
                        </li>
                    </ul>
                </div>
            </div>
                                ...
                                <div class="element-box lined-primary shadow">              
                                    <div class="element-wrapper">
                                        <div class="element-box-tp">
                                            <h6 class="element-header"><?php echo getPhrase('attendance_report');?> <?php echo getPhrase('of');?> [<?php echo $this->db->get_where('subject', array('subject_id' => $ex[2]))->row()->name;?>]</h6>
