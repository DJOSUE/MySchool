<?php 
    ...
    $fancy_cl_id = $this->db->get_where('enroll', array('student_id' => $fc_ex[3]))->row()->class_id;
    $fancy_sec_id = $this->db->get_where('enroll', array('student_id' => $fc_ex[3]))->row()->section_id;
    $fancy_section_id = $this->db->get_where('enroll', array('student_id' => $fc_ex[3]))->row()->section_id;
?>
    ...
    <div class="page-title">
        <div class="fancy-selector-w">
            ...
            <div class="fancy-selector-options active">
                <?php 
                    $fancy_subjectss = $this->db->get_where('subject', array('class_id' => $fancy_cl_id, 'section_id' => $fancy_sec_id))->result_array();
                    foreach($fancy_subjects as $fancy_row2):
                ?>
                <a
                    href="<?php echo base_url();?>parents/subject_dashboard/<?php echo base64_encode($fancy_cl_id.'-'.$fancy_section_id.'-'.$fancy_row2['subject_id'].'-'.$fc_ex[3]);?>/">
        ...
        <div class="control-block">
                        ...
                        <ul class="notification-list chat-message">
                            ...
                            <li class="message-unread">
                                ...
                                <div class="notification-event">
                                    <a href="<?php echo base_url();?>parents/message/message_read/<?php echo $fancy_rows['message_thread_code'];?>/"
            ...
            <div class="control-icon more has-items">
                ...
                <div class="more-dropdown more-with-triangle triangle-top-center">
                    ...
                    <a href="<?php echo base_url();?>parents/notifications/"
            ...
            <div class="author-page author vcard inline-items more">
                <div class="author-thumb">
                    <img alt="author"
                        src="<?php echo $this->crud->get_image_url('parent', get_login_user_id());?>"
                ...
                <a href="#" class="author-name fn">
                    <div class="author-title">
                        <?php echo $this->crud->get_name('parent', get_login_user_id());?> <svg
            ...
            <div class="mCustomScrollbar" data-mcs-theme="dark">
                <ul class="notification-list chat-message">
                    ...
                    <li class="message-unread">
                        ...
                        <div class="notification-event">
                            <a href="<?php echo base_url();?>parents/message/message_read/<?php echo $row1['message_thread_code'];?>/"
                                class="h6 notification-friend"><?php echo $this->crud->get_name($fancy_user_to_show_type, $fancy_user_to_show_id);?></a>
                            <span class="chat-message-item"
                                style="text-align: justify;"><?php if($rw->sender == $fancy_current_user) echo getPhrase('you').": ". substr($rw->message, 0, 90).'...'; else echo substr($rw->message, 0, 90);?>...</span>
                            <span class="notification-date"><time
