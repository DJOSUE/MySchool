                            ...
                            <div class="infos">
                                ...
                                <div class="info-2">
                                    ...
                                    <div class="company-address">
                                        <?php echo getPhrase('roll');?>: <?php echo $this->db->get_where('enroll', array('student_id' => $ex[0]))->row()->roll;?><br/><?php echo $this->db->get_where('class', array('class_id' => $class_id))->row()->name;?><br/><?php echo $this->db->get_where('section' , array('section_id' => $section_id))->row()->name;?>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="rcard-table table-responsive">
                                <table class="table">
                                    ...
                                    <?php 
                                        ...
                                        $mark = $this->db->get_where('mark' , array('student_id' => $ex[0],'subject_id' => $row3['subject_id'], 'class_id' => $class_id, 'unit_id' => $ex[1], 'year' => $running_year));    
                                        if($mark->num_rows() > 0) 
                                        {
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="text-center"><?php echo $this->db->get_where('mark' , array('subject_id' => $row3['subject_id'], 'unit_id' => $ex[1], 'student_id'=> $ex[0],'year' => $running_year))->row()->labtotal; ?></td>
                                            <td class="text-center"><?php echo $this->db->get_where('mark' , array('subject_id' => $row3['subject_id'], 'unit_id' => $ex[1], 'student_id'=> $ex[0],'year' => $running_year))->row()->comment; ?></td>
                                        </tr>
