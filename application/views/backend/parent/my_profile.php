    											...
    											<div class="row">
												    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
    													<ul class="widget w-personal-info item-block">
														    ...
														    <li>
    															<span class="title"><?php echo getPhrase('work_business');?>:</span>
												    ...
												    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
    													<ul class="widget w-personal-info item-block">
														    ...
														    <li>
    															<span class="title"><?php echo getPhrase('home_phone');?>:</span>
															    <span class="text"><?php echo $row['home_phone'];?></span>
														    </li>
														    <li>
    															<span class="title"><?php echo getPhrase('work_phone');?>:</span>
                    						...
                    						<div class="help-support-block">
    											...
    											<ul class="help-support-list">
    												<li>
    													...
    													<a href="<?php echo base_url();?>parents/my_profile/"><?php echo getPhrase('personal_information');?></a>
    												</li>
    												<li>
    													<i class="picons-thin-icon-thin-0133_arrow_right_next px20"></i> &nbsp;&nbsp;&nbsp;
    													<a href="<?php echo base_url();?>parents/parent_update/"><?php echo getPhrase('update_information');?></a>
    												</li>
    											</ul>
    										</div>
    									</div>
                                        ...
                                        <div class="pricing-plans row no-gutters">
                                            <div class="pricing-plan col-sm-6">
                                                ...
                                                <div class="plan-body"><br><br>
                                                    ...
                                                    <?php else:?>
                                                        <a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>parents/my_profile/remove_facebook/"><?php echo getPhrase('unlink');?></a>
                                                        <?php endif;?>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="pricing-plan col-sm-6">
                                                ...
                                                <div class="plan-body"><br><br>
                                                    ...
                                                    <?php else:?>
                                                        <a class="btn btn-danger btn-rounded" href="<?php echo base_url();?>parents/my_profile/remove_google/"><?php echo getPhrase('unlink');?></a>
                                                    <?php endif;?>
                                                    </div>
                                                </div>
                                            </div>
