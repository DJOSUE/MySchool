                                        ...
                                        <article class="hentry post">
                                            ...
                                            <div>
                                                <div class="wall-content">
                                                    ...
                                                    <a href="javascript:void(0);" class="btn btn-md-2 btn-vote text-white btn-border-think custom-color c-grey" onClick="vote('<?php echo $poll_code;?>')"><?php echo getPhrase('vote');?><div class="ripple-container"></div></a>
                                                </div>
                                            </div>
                                            <br><br><br>
                                        </article>
                                    ...
                                    <div class="sidebar__inner">
                                        ...
                                        <div class="ui-block paddingtel">
                                            <div class="widget w-create-fav-page">
                                                ...
                                                <div class="content">
                                                    <h3 class="title"><?php echo getPhrase('welcome_message_parent');?></h3>
                                                    <a href="<?php echo base_url();?>parents/progress/" class="btn btn-warning btn-sm"><?php echo getPhrase('go_to_timeline');?></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="ui-block paddingtel">
