                                ...
                                <table class="table table-padded">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td class="bolder">
                                                <a href="<?php echo base_url();?>parents/view_report/<?php echo $row['code'];?>/" class="grey"><i class="px20" class="picons-thin-icon-thin-0012_notebook_paper_certificate" data-toggle="tooltip" data-placement="top" data-original-title="<?php echo getPhrase('view_details');?>"></i></a>
                                            </td>
                                        </tr>
                                    <?php endforeach;?>
                                    </tbody>
