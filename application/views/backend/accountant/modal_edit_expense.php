...
?>   
    <div class="modal-body">
        <div class="modal-header" style="background-color:#00579c">
            <h6 class="title" style="color:white"><?php echo getPhrase('update_expense');?></h6>
        </div>
        <div class="ui-block-content">
            <?php echo form_open(base_url() . 'accountant/expense/edit/'.$row['payment_id'] , array('enctype' => 'multipart/form-data'));?>
                <div class="row">
                    ...
                    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                        <div class="form-group label-floating">
                            <label class="control-label"><?php echo getPhrase('total');?></label>
                        ...
                        <div class="form-group label-floating is-select">
                            ...
                            <div class="select">
                                <select name="method" required>
                                    <option value=""><?php echo getPhrase('select');?></option>
                                    <option value="1" <?php if ($row['method'] == 1) echo 'selected';?>><?php echo getPhrase('cash');?></option>
                                    <option value="2" <?php if ($row['method'] == 2) echo 'selected';?>><?php echo getPhrase('check');?></option>
                                    <option value="3" <?php if ($row['method'] == 3) echo 'selected';?>><?php echo getPhrase('card');?></option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                        <button class="btn btn-rounded btn-success btn-lg " type="submit"><?php echo getPhrase('save');?></button>
                    </div>
                </div>
            <?php echo form_close();?>
        </div>
