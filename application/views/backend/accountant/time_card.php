<?php
    ...
    $worker = $this->db->get_where('worker', array('type_user' => 'accountant', 'user_id' => $user_id))->row();
        ...
        <div class="os-tabs-w menu-shad">
            <div class="os-tabs-controls">
                <ul class="navs navs-tabs">
                    <li class="navs-item">
                        <a class="navs-links <?php if($page_name == 'time_card') echo "active";?>" href="<?php echo base_url();?>accountant/time_card/"><i class="picons-thin-icon-thin-0844_stopwatch_training_time"></i> <span><?php echo getPhrase('time_card');?></span></a>
                    </li>
                    <li class="navs-item">
                        <a class="navs-links" href="<?php echo base_url();?>accountant/time_sheet/"><i class="picons-thin-icon-thin-0023_calendar_month_day_planner_events"></i>  <span><?php echo getPhrase('time_sheet');?></span></a>
                    </li>
                </ul>
            </div>
        </div>
...
<script type="text/javascript">
    function clockIn(_idWorker) {
        ...
        $.ajax({
            url: '<?php echo base_url();?>accountant/timesheet_actions/clock-in/',
            type: 'POST',
            data: {
                worker_id: worker_id,
                pcinfo_in: pcinfo_in
    ...
    function clockOut(clockIn_id) {
        ...
        var url = '<?php echo base_url();?>accountant/timesheet_actions/clock-out/'+clockIn_id;
