                                        ...
                                        <div class="up-main-info">
                                            <div class="user-avatar-w">
                                                <div class="user-avatar">
                                                    <img alt=""
                                                        src="<?php echo $this->crud->get_image_url('accountant', $row['accountant_id']);?>"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="value-pair">
                                                    ...
                                                    <div class="value badge badge-pill badge-primary">
                                                        <?php echo getPhrase('accountant');?></div>
                                                </div>
                                                <div class="value-pair">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col col-lg-6 col-md-6 col-sm-12 col-12">
                                                    <ul class="widget w-personal-info item-block">
                                                        ...
                                                        <li>
                                                            <span class="title">
                                                                <?php echo getPhrase('gender');?>:
															</span>
                                                            <span class="text">
																<?= $this->db->get_where('gender', array('code' => $row['gender']))->row()->name;?>
															</span>
                                                        </li>
                                                        <li>
                                                            <span
                                        ...
                                        <div class="help-support-block">
                                            ...
                                            <ul class="help-support-list">
                                                <li>
                                                    ...
                                                    &nbsp;&nbsp;&nbsp;
                                                    <a
                                                        href="<?php echo base_url();?>accountant/my_profile/"><?php echo getPhrase('personal_information');?></a>
                                                </li>
                                                <li>
                                                    <i class="picons-thin-icon-thin-0133_arrow_right_next px20"></i>
                                                    &nbsp;&nbsp;&nbsp;
                                                    <a
                                                        href="<?php echo base_url();?>accountant/accountant_update/"><?php echo getPhrase('update_information');?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                            ...
                                            <div class="plan-body"><br><br>
                                                <div class="plan-btn-w">
                                                    ...
                                                    <a class="btn btn-danger btn-rounded"
                                                        href="<?php echo base_url();?>accountant/my_profile/remove_facebook/"><?php echo getPhrase('unlink');?></a>
                                                    <?php endif;?>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pricing-plan col-sm-6">
                                            ...
                                            <div class="plan-body"><br><br>
                                                <div class="plan-btn-w">
                                                    ...
                                                    <?php else:?>
                                                    <a class="btn btn-danger btn-rounded"
                                                        href="<?php echo base_url();?>accountant/my_profile/remove_google/"><?php echo getPhrase('unlink');?></a>
                                                    <?php endif;?>
                                                </div>
                                            </div>
                                        </div>
