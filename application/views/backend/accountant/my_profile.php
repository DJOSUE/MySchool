              								...
              								<div class="row">
          								        <div class="col-lg-6">
              								        <div class="value-pair">
          								                ...
          								                <div class="value badge badge-pill badge-primary"><?php echo getPhrase('accountant');?></div>
          								            </div>
          								            <div class="value-pair">
                						        ...
                						        <div class="help-support-block">
											        ...
											        <ul class="help-support-list">
												        <li>
													        ...
													        <a href="<?php echo base_url();?>accountant/my_profile/"><?php echo getPhrase('personal_information');?></a>
												        </li>
												        <li>
													        <i class="picons-thin-icon-thin-0133_arrow_right_next px20"></i> &nbsp;&nbsp;&nbsp;
													        <a href="<?php echo base_url();?>accountant/accountant_update/"><?php echo getPhrase('update_information');?></a>
												        </li>
											        </ul>
										        </div>
									        </div>
