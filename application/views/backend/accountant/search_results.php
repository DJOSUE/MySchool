<?php 
    $return_url = base64_encode('/accountant/search_results?query='.$search_key);
                            ...
                            <ul class="notification-list">
                                ...
                                <li>
                                    ...
                                    <div class="notification-event">
                                        <a href="<?= base_url();?>accountant/student_profile/<?= $row['student_id'];?>/"
                                    ...
                                    <div class="navs-links action-right">
                                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top"
                                            ...
                                            onclick="showAjaxModal('<?= base_url();?>modal/popup_task/modal_task_add/<?= $row['student_id'].'/student/'.$return_url;?>');">
                                    ...
                                    <div class="navs-links action-right">
                                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top"
                                            ...
                                            onclick="showAjaxModal('<?= base_url();?>modal/popup_task/modal_student_add_interaction/<?= $row['student_id'].'/'.$return_url;?>');">
                            ...
                            <ul class="notification-list">
                                ...
                                <li>
                                    ...
                                    <div class="navs-links action-right">
                                        <a href="javascript:void(0);" data-toggle="tooltip" data-placement="top"
                                            data-original-title="<?= getPhrase('add_task');?>"
                                            onclick="showAjaxModal('<?= base_url();?>modal/popup_task/modal_task_add/<?= $row['applicant_id'].'/applicant/'.$return_url;?>');">
                                            <i class="picons-thin-icon-thin-0706_user_profile_add_new"></i>
                                        </a>
                                    </div>
                                    <div class="navs-links action-right">
