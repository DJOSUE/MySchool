				        ...
				        <div class="tab-content">
                            <div class="os-tabs-w bg-white">
                                <ul class="navs navs-tabs upper centered">
                                    <li class="navs-item">
                                        <a class="navs-links <?php if($page_name == 'message' && $message_inner_page_name != 'message_new') echo "active";?>" href="<?php echo base_url();?>accountant/message/" style="color:#000"><i class="os-icon picons-thin-icon-thin-0306_chat_message_discussion_bubble_conversation" style="color:#047bf8"></i><span><?php echo getPhrase('chats');?></span></a>
                                    </li>
                                    <li class="navs-item">
                                        <a class="navs-links <?php if($message_inner_page_name == 'message_new') echo "active";?>" href="<?php echo base_url();?>accountant/message/message_new/" style="color:#000"><i class="os-icon picons-thin-icon-thin-0001_compose_write_pencil_new" style="color:#047bf8"></i><span><?php echo getPhrase('write');?></span></a>
                                    </li>
                                    <li class="navs-item">
                                        <a class="navs-links" href="<?php echo base_url();?>accountant/group/" style="color:#000"><i class="os-icon picons-thin-icon-thin-0719_group_users_circle" style="color:#047bf8"></i><span><?php echo getPhrase('groups');?></span></a>
                                    </li>
                                </ul>
                            </div>
                            					...
                            					<?php if ($unread_message_number > 0): ?>
                              					...
                              					<div class="last-message">
                                					<?php if($user_to_show_type =='admin') : ?>
                                 						<a class="badge badge-success" href="<?php echo base_url(); ?>accountant/message/message_read/<?php echo $row['message_thread_code']; ?>" style="color:white"><?php echo getPhrase('admin');?></a>
                               						<?php endif;?>
                              					</div>
                            				</div>
                          				</div>
