        ...
        <div class="header-content-wrapper" style="padding-left: 85px;">
            ...
            <div class="control-block">
                ...
                <div class="author-page author vcard inline-items more">
                    <div class="author-thumb">
                        <img alt="author"
                            src="<?php echo $this->crud->get_image_url('accountant', get_login_user_id());?>"
                    ...
                    <a href="javascript:void(0);" class="author-name fn">
                        <div class="author-title">
                            <?php echo $this->crud->get_name('accountant', get_login_user_id());?>
                        ...
                        <span
                            class="author-subtitle"><?php echo ucwords(get_account_type());?></span>
                    </a>
                </div>
            </div>
        </div>
