            ...
            <div class="control-block">
                <div class="control-icon more has-items">
                    ...
                    <div class="more-dropdown more-with-triangle triangle-top-center">
                        ...
                        <a href="<?php echo base_url();?>accountant/message/" class="view-all bg-info"><?php echo getPhrase('view_all_messages');?></a>
                    </div>
                </div>
                <div class="control-icon more has-items">
                    ...
                    <div class="more-dropdown more-with-triangle triangle-top-center">
                        ...
                        <a href="<?php echo base_url();?>accountant/notifications/" class="view-all bg-info"><?php echo getPhrase('view_all_notifications');?></a>
                    </div>
                </div>
        ...
        <div class="tab-content tab-content-responsive">
            ...
            <div class="tab-pane " id="notification" role="tabpanel">
                <div class="mCustomScrollbar" data-mcs-theme="dark">
                    ...
                    <a href="<?php echo base_url();?>accountant/notifications/" class="view-all bg-info"><?php echo getPhrase('vew_all_notifications');?></a>
                </div>
            </div>
