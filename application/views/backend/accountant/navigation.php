            ...
            <div class="mCustomScrollbar" data-mcs-theme="dark">
                <ul class="left-menu">
                    ...
                    <li <?php if($page_name == 'panel'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>accountant/panel/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('dashboard');?>">
                    ...
                    <li <?php if($page_name == 'time_card' || $page_name == 'time_sheet'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>accountant/time_card/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('time_card');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'message' || $page_name == 'group'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>accountant/message/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('messages');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'news'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>accountant/news/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('news');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'payments' || $page_name == 'students_payments' || $page_name == 'expense' || $page_name == 'new_payment'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>accountant/payments/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('accounting');?>">
                            <div class="left-menu-icon">
                    ...
                    <li <?php if($page_name == 'calendar'):?>class="currentItem"<?php endif;?>>
                        <a href="<?php echo base_url();?>accountant/calendar/" data-toggle="tooltip" data-placement="right" data-original-title="<?php echo getPhrase('calendar');?>">
                            <div class="left-menu-icon">
