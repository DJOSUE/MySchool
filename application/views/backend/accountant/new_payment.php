	                ...
	                <div class="element-wrapper">
		                <div class="os-tabs-w">
			                <div class="os-tabs-controls">
			                    <ul class="navs navs-tabs upper">
				                    <li class="navs-item">
				                        <a class="navs-links active" data-toggle="tab" href="#single"><?php echo getPhrase('single_invoice');?></a>
				                    </li>
				                    <li class="navs-item">
				                        <a class="navs-links" data-toggle="tab" href="#bulk"><?php echo getPhrase('bulk_invoice');?></a>
				                    </li>
			                    </ul>
			                </div>
		                </div>
		                <div class="tab-content">
			                        ...
			                        <div class="col-sm-6">
		                                <?php echo form_open(base_url() . 'accountant/invoice/create');?>
                                            <div class="element-box lined-primary shadow">
		                                        <h5 class="form-header"><?php echo getPhrase('invoice_details');?></h5><br>
		                                        <div class="row">
		                                ...
		                                <div class="col-sm-6">
                                            <div class="element-box lined-success shadow">
		                                        <h5 class="form-header"><?php echo getPhrase('payment_details');?></h5><br>
    		                                    <div class="row">
		                                            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="form-group label-floating">
                                                        ...
                                                        <div class="form-group label-floating is-select">
                                                            ...
                                                            <div class="select">
                                                                <select name="status" required="">
                                                                    <option value=""><?php echo getPhrase('select');?></option>
                                                                    <option value="completed"><?php echo getPhrase('completed');?></option>
					                                                <option value="pending"><?php echo getPhrase('pending');?></option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    </div>
		                                            ...
		                                            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <button class="btn btn-success btn-rounded" type="submit"><?php echo getPhrase('create_invoice');?></button>
                                                    </div>
                                                </div>
		                                    </div>
		                                <?php echo form_close();?>
		    	            ...
		    	            <div class="tab-pane" id="bulk">
		  		                <?php echo form_open(base_url() . 'accountant/invoice/bulk', array('class' => 'form-horizontal form-groups-bordered validate', 'id'=> 'mass' ,'target'=>'_top'));?>
		                            ...
		                            <div class="col-sm-6">
                                        <div class="element-box lined-success shadow">
		                                    <h5 class="form-header"><?php echo getPhrase('students');?></h5><br>
		                                    <div class="row">
		                                        <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
                                                    <div class="form-group label-floating is-select">
                                                        <label class="control-label"><?php echo getPhrase('status');?></label>
