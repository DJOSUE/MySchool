            ...
            <div class="content-i">
	            <div class="content-box">
	                <div class="element-wrapper">
    	                <a href="<?php echo base_url();?>accountant/students_payments/" class="btn btn-rounded btn-info"><i class="picons-thin-icon-thin-0131_arrow_back_undo"></i> <?php echo getPhrase('return');?></a>
	                    <button type="button" class="btn btn-rounded btn-success" onclick="Print('invoiceid')"><?php echo getPhrase('print');?></button>
	                    <br><br>
