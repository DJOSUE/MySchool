            ...
            <div class="os-tabs-w menu-shad">
                <div class="os-tabs-controls">
                    <ul class="navs navs-tabs upper">
                        <li class="navs-item">
                            <a class="navs-links active" href="<?php echo base_url();?>accountant/payments/"><i class="os-icon picons-thin-icon-thin-0482_gauge_dashboard_empty"></i><span><?php echo getPhrase('home');?></span></a>
                        </li>
                        <li class="navs-item">
                            <a class="navs-links" href="<?php echo base_url();?>accountant/students_payments/"><i class="os-icon picons-thin-icon-thin-0426_money_payment_dollars_coins_cash"></i><span><?php echo getPhrase('payments');?></span></a>
                        </li>
                        <li class="navs-item">
					                                                ...
					                                                <div class="friend-item-content">
						                                                ...
						                                                <br><br>
							                                                ...
							                                                <div class="author-content">
								                                                <div class="country"><b> <?php echo getPhrase('total_income');?></b></div>
							                                                </div>
						                                                </div>
					                                                </div>
				                                                </div>
                                                				...
                                                				<div class="friend-item friend-groups">
                                                					<div class="friend-item-content">
                                                						<div class="friend-avatar">
                                                							...
                                                							<div class="author-content">
                                                								<div class="country"><b> <?php echo getPhrase('total_expense');?></b></div>
                                                							</div>
                                                						</div>
                                                					</div>
                                                				</div>
                                                				...
                                                				<div class="friend-item friend-groups">
                                                					<div class="friend-item-content">
                                                						<div class="friend-avatar">
                                                							...
                                                							<div class="author-content">
                                                								<div class="country"><b> <?php echo getPhrase('pending_payments');?></b></div>
                                                							</div>
                                                						</div>
                                                					</div>
                                                				</div>
                                                				...
                                                				<div class="friend-item friend-groups">
                                                					<div class="friend-item-content">
                                                						<div class="friend-avatar">
                                                							...
                                                							<div class="author-content">
                                                								<div class="country"><b> <?php echo getPhrase('completed_payments');?></b></div>
                                                							</div> 
                                                						</div>
                                                					</div>
                                                				</div>
                                                    ...
                                                    <div class="row"> 
		                                                <div class="col-sm-6">
			                                                <div class="element-wrapper">
			                                                    <h6 class="element-header"><?php echo getPhrase('recent_income');?></h6>
                                                                            ...
                                                                            <tbody>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="cell-with-media">
                                                                                        <a href="<?php echo base_url();?>accountant/invoice_details/<?php echo $row['invoice_id'];?>/" class="grey"><img alt="" src="<?php echo $this->crud->get_image_url('student', $row['student_id']);?>" style="height: 25px;"><span> <?php echo $this->crud->get_name('student', $row['student_id']);?></span></a>
                                                                                    </td>
		                                                ...
		                                                <div class="col-sm-6">
                                                		   <div class="element-wrapper">
                                                              <h6 class="element-header"><?php echo getPhrase('recent_expense');?></h6>
                                                                <div class="element-box-tp">
                                                                    <div class="table-responsive">
                                                                        <table class="table table-padded">
                                                                            <thead>
