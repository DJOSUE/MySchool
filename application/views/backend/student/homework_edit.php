			                ...
			                <?php if($row['type'] != 1):?>
    			                <div class="b-t padded-v-big">
    			                    <?php echo form_open(base_url() . 'student/delivery/update_file/'.$delivery_id.'/'.$homework_code , array('enctype' => 'multipart/form-data'));?>
    			                        ...
    			                        <div class="row">
    			                            <div class="col-sm-12">
                                                <textarea class="form-control" placeholder="<?php echo getPhrase('send_teacher_comment');?>" name="comment" rows="5" style="width:100%"><?php echo $query->row()->student_comment;?></textarea>
