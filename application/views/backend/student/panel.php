                                    ...
                                    <div class="sidebar__inner">
                                        ...
                                        <div class="ui-block paddingtel">
    				                        <div class="widget w-create-fav-page">
    					                        ...
    					                        <div class="content">
    						                        <h3 class="title"><?php echo getPhrase('student_welcome_dashboard_message');?></h3>
    						                        <a href="<?php echo base_url();?>student/progress/" class="btn btn-warning btn-sm"><?php echo getPhrase('go_to_my_timeline');?></a>
    					                        </div>
    				                        </div>
    			                        </div>
    			                        <div class="ui-block paddingtel">
