    ...
    <div class="conty">
        <div class="content-i">
            <div class="content-box">
                <div class="back">
                    <a
                        href="<?= base_url();?>student/forum/<?= base64_encode($row['class_id']."-".$row['section_id']."-".$row['subject_id']);?>/"><i
                    ...
                    <div class="col-sm-8">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="posts">
                                            ...
                                            <?= getPhrase('file');?>: <a class="btn btn-rounded btn-sm btn-primary"
                                                href="<?= base_url();?>public/uploads/forum/<?= $row['file_name'];?>"
                                                style="color:white">
                                                <i class="os-icon picons-thin-icon-thin-0042_attachment"></i>
                                                <?= $row['file_name'];?></a>
                                            <?php endif;?>
                                        </td>
                                    </tr>
                        ...
                        <div class="element-box shadow lined-success">
                            <div class="row" style="margin:2px;margin-bottom:15px">
                                <div class="col-sm-12">
                                    <input type="hidden" value="<?= $post_code;?>" id="post_code" name="post_code">
...
$(document).ready(function() {
    $("#add").click(function() {
        ...
        if (message != "" && post_code != "") {
            $.ajax({
                url: "<?= base_url();?>student/forum_message/add",
                type: 'POST',
                data: {
                    message: message,
                    post_code: post_code
