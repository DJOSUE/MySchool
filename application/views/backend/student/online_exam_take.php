        ...
        <div class="conty">
            ...
            <div class="ui-block responsive-flex1200">
                <div class="ui-block-title">
                    ...
                    <h4><b><?php echo getPhrase('duration');?></b>: <?php echo ($online_exam_row->duration / 60).' '.getPhrase('minutes');?></h4>
                    <div style="height:30px; font-size:25px; font-weight:200; color: #212121;" id="timer_value">
                        <span id="hour_timer"> 0 </span>
                        <span style="font-size:20px;"><?php echo getPhrase('hour');?> </span>
                        <span class="blink_text">:</span>
                        <span id="minute_timer"> 0 </span>
                        <span style="font-size:20px;"><?php echo getPhrase('minute');?> </span>
                        <span class="blink_text">:</span>
                        <span id="second_timer"> 0 </span>
                        <span style="font-size:20px;"><?php echo getPhrase('second');?> </span>
                    </div>
                </div>
            </div><hr>
            <div class="content-i">
                <div class="content-box">
                    <form class="" action="<?php echo base_url();?>student/submit_online_exam/<?php echo $online_exam_id;?>/" method="post" enctype="multipart/form-data" id="answer_script">
                            ...
                            <element class="col-sm-6 col-aligncenter page " id="page<?php echo $var;?>">
                                <div class="pipeline white lined-primary">            
                                    <div class="pipeline-header">
                                        ...
                                        <span><?php echo getPhrase('mark');?>: <?php echo $question['mark'];?></span>
                                    </div>
                                ...
                                <?php if ($question['type'] == 'fill_in_the_blanks'): ?>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" name="<?php echo $question['question_bank_id'].'[]'; ?>" value="" class="form-control" placeholder="<?php echo getPhrase('answer');?>">
                                        </div>
                                    </div>
                                <?php endif; ?>   
                                </div>
                        ...
                        <div class="col-sm-12 text-center">
                            <button class="btn btn-rounded btn-success text-center" id="subbutton"><?php echo getPhrase('finish_exam');?></button>
                        </div>
                    </form>
                </div>  
            </div>  
