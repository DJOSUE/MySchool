                                ...
                                <article class="hentry post thumb-full-width">
                                    ...
                                    <div class="edu-posts cta-with-media verde">
                                        <div class="cta-content">
                                            ...
                                            <a
                                                href="<?php echo base_url();?>student/homeworkroom/<?php echo $this->db->get_where('homework', array('homework_id' => $wall['homework_id']))->row()->homework_code;?>/"><button
                                ...
                                <article class="hentry post thumb-full-width">
                                    ...
                                    <div class="edu-posts cta-with-media verde">
                                        <div class="cta-content">
                                            ...
                                            <a href="<?php echo base_url();?>student/online_exams/<?php echo $data;?>/"><button
                                                    class="btn btn-rounded btn-posts verde"><i
                                                        class="picons-thin-icon-thin-0014_notebook_paper_todo"></i>
                                                    <?php echo getPhrase('go_to_exams');?></button></a>
                                        </div>
                                    </div>
                                    <div class="control-block-button post-control-button">
                                ...
                                <article class="hentry post thumb-full-width">
                                    ...
                                    <div class="edu-posts cta-with-media verde">
                                        <div class="cta-content">
                                            ...
                                            <a
                                                href="<?php echo base_url();?>student/forumroom/<?php echo $this->db->get_where('forum', array('post_id' => $wall['homework_id']))->row()->post_code;?>/"><button
                                                    class="btn btn-rounded btn-posts"><i
                                                        class="picons-thin-icon-thin-0014_notebook_paper_todo"></i>
