                ...
                <div class="content-box">
    	            <?php echo form_open(base_url() . 'student/take_online_exam/start');?>
		                ...
		                <div class="element-box lined-primary shadow"  style="text-align:center">
			                <div class="col-sm-8" style="margin: 0 auto;"><h3 class="form-header"><?php echo getPhrase('exam_information');?></h3><br>
			                ...
			                <div class="table-responsive col-sm-8" style="margin: 0 auto; text-align:left">
			                    <table class="table table-lightbor table-lightfont">
			                        <tr>
				                        ...
				                        <td>
				                            <strong> <?php echo getPhrase('total_questions');?>:</strong> <?php $this->db->where('online_exam_id',$row['online_exam_id']);  echo $this->db->count_all_results('question_bank');?>.
				                        </td>
			                        </tr>
			                        <tr>
				                        <th><i class="picons-thin-icon-thin-0027_stopwatch_timer_running_time" style="font-size:30px"></i></th>
				                        <td>
				                            <strong> <?php echo getPhrase('duration');?>:</strong> <?php $minutes = number_format($row['duration']/60,0); echo $minutes;?> <?php echo getPhrase('minutes');?>.
				                        </td>
			                        </tr>
			                        <tr>
				                        <th><i class="picons-thin-icon-thin-0007_book_reading_read_bookmark" style="font-size:30px"></i></th>
				                        <td>
				                            <strong> <?php echo getPhrase('average_required');?>:</strong> <a class="btn btn-rounded btn-sm btn-primary" style="color:white"><?php echo $row['minimum_percentage'];?>%</a>
				                        </td>
			                        </tr>
			                        <tr>
				                        <th><i class="picons-thin-icon-thin-0207_list_checkbox_todo_done" style="font-size:30px"></i></th>
				                        <td><?php echo getPhrase('answer_all_questions');?>.</td>
			                        </tr>
			                        <tr>
				                        <th><i class="picons-thin-icon-thin-0376_screen_analytics_line_graph_growth" style="font-size:30px"></i></th>
				                        <td><?php echo getPhrase('finish_message');?></td>
			                        </tr>
			                        <?php if($row['password'] != ''):?> 
			                        <tr>
				                        <th><i class="picons-thin-icon-thin-0136_rotation_lock" style="font-size:30px"></i></th>
				                        <td>
				                            <?php echo getPhrase('enter_exam_password');?>: 
				    	                    <input type="text" name="password" placeholder="<?php echo getPhrase('enter_exam_password');?>" class="form-control" required="">
				    	                </td>
			                        </tr>
			                        <?php endif;?>
			                        <tr>
				                        ...
				                        <td style="color:red">
				                            <strong><?php echo getPhrase('important');?>!</strong> <?php echo getPhrase('important_message');?>.
				                        </td>
			                        </tr>
		                        </table>
		                    </div>		
		                    <button class="btn btn-rounded btn-lg btn-success" type="submit"><?php echo getPhrase('start_exam');?></button>
		                </div>
		            <?php echo form_close();?>
                </div>
            </div>
