                                                ...
                                                <div class="todo-task">
                                                    ...
                                                    <?php elseif($row['wall_type'] == 'live'):?>
                                                        <?php 
                                                            ...
                                                            $subject_name = $this->db->get_where('subject', array('subject_id' => $subject_id))->row()->name;
                                                        ?>
                                                        <span data-container="body" data-content="<i class='picons-thin-icon-thin-0021_calendar_month_day_planner'></i> <?php echo $row['time_end'];?>.<br><i class='picons-thin-icon-thin-0025_alarm_clock_ringer_time_morning'></i> <?php echo $row['date_end'];?>.<br><a style='margin-top:10px;color:#fff' class='badge badge-primary' href='<?php echo base_url();?>student/meet/<?php echo $redirect;?>/' target='_blank'><?php echo getPhrase('go_to_details');?></a>" data-placement="top" data-toggle="popover" title="" data-html="true" data-original-title="<?php echo $row['title'];?>"><i class="os-icon picons-thin-icon-thin-0591_presentation_video_play_beamer" title="<?php echo getPhrase('live');?>"></i>  <?php echo $row['title'];?>. (<b><?php echo $subject_name;?></b>)</span>
                                                    <?php endif;?>
                                                </div> 
                                            </li>
                                        <?php endforeach;?>
