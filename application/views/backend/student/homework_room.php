	        ...
	        <div class="os-tabs-w menu-shad">
		        <div class="os-tabs-controls">
		            <ul class="navs navs-tabs upper">
			            <li class="navs-item">
			                <a class="navs-links active" href="#"><i class="os-icon picons-thin-icon-thin-0014_notebook_paper_todo"></i><span><?php echo getPhrase('homework_details');?></span></a>
			            </li>
		            </ul>
		        </div>
	        </div>
	                    ...
	                    <div class="col-sm-8">
		                    <div class="pipeline white lined-primary shadow">
			                    ...
			                    <div class="b-t padded-v-big">
				                    <?php echo getPhrase('file');?>: <a class="btn btn-rounded btn-sm btn-primary" href="<?php echo base_url() . 'public/uploads/homework/' . $row['file_name']; ?>" style="color:white"><i class="os-icon picons-thin-icon-thin-0042_attachment"></i> <?php echo $row['file_name'];?></a>
			                    </div>
			                    <?php endif;?>
			                    ...
			                    <div class="b-t padded-v-big">
			                        <?php echo form_open(base_url() . 'student/delivery/file/'.$homework_code , array('enctype' => 'multipart/form-data'));?>
				                        <div class="form-group">
					                        <label><?php echo getPhrase('upload_files');?>:</label><br>
			                            ...
			                            <div class="row">
			                                <div class="col-sm-12">
                                                <textarea class="form-control" placeholder="<?php echo getPhrase('send_teacher_comment');?>" name="comment" rows="5" style="width:100%"></textarea>
                                                <button type="submit" class="btn btn-success pull-right text-white"><?php echo getPhrase('send');?></button>
				                            </div>
				                        </div>
			                        <?php echo form_close();?>
			                    </div>
			                    <?php endif;?>
			                    <?php if($row['type'] == 1 && $query->num_rows() <= 0):?>
			                    <div class="alert alert-info" role="alert"><?php echo getPhrase('no_required');?></div>
		                        <?php echo form_open(base_url() . 'student/delivery/text/'.$homework_code);?>
		                            <div class="b-t padded-v-big">
		                                ...
		                                <div class="row">
		                                    <div class="col-sm-12">
                                                <textarea class="form-control" placeholder="<?php echo getPhrase('send_teacher_comment');?>" name="comment" rows="5" style="width:100%"></textarea>
                                                <button type="submit" class="btn btn-success pull-right text-white" href="javascript:void(0);"><?php echo getPhrase('send');?></button>
			                                </div>
			                            </div>
		                            </div>
		                        <?php echo form_close();?>
			                    ...
			                    <hr>
			                    <p><b><?php echo getPhrase('your_comment');?>:</b></p>
			                    ...
			                    <?php endif;?>
			                    <a class="btn btn-rounded btn-edu text-white" href="<?php echo base_url();?>student/homework_edit/<?php echo base64_encode($query->row()->id);?>/"><i class="picons-thin-icon-thin-0001_compose_write_pencil_new"></i> <?php echo getPhrase('edit_delivery');?></a>
			                    <br><br>
				                <div class="alert alert-success" role="alert"><strong><?php echo getPhrase('success');?>. </strong><?php echo getPhrase('success_delivery');?>.</div>
			                    <?php endif;?>
		                    </div>
		                </div>
	                    <div class="col-sm-4">
		                    <div class="pipeline white lined-secondary">
    		                    ...
    		                    <div class="table-responsive">
		                            <table class="table table-lightbor table-lightfont">
			                            <tr>
				                            <th><b><?php echo getPhrase('subject');?></b>:</th>
				                            <td><?php echo $this->crud->get_type_name_by_id('subject',$row['subject_id']);?></td>
			                            </tr>
			                            <tr>
				                            <th><b><?php echo getPhrase('class');?></b>:</th>
				                            <td><?php echo $this->crud->get_type_name_by_id('class',$row['class_id']);?></td>
			                            </tr>
			                            <tr>
				                            <th><b><?php echo getPhrase('section');?></b>:</th>
				                            <td><?php echo $this->crud->get_type_name_by_id('section',$row['section_id']);?></td>
			                            </tr>
			                            <tr>
				                            <th><b><?php echo getPhrase('limit_date');?></b>:</th>
				                            <td><?php echo getPhrase('allowed_deliveries');?> <?php echo $row['date_end'];?> <?php echo $row['time_end'];?>.</td>
			                            </tr>
			                            <tr>
				                            <th><b><?php echo getPhrase('status');?></b>:</th>
				                            <td>
				 	                        <?php if($query->num_rows() <= 0):?>
				  		                        <a class="btn nc btn-rounded btn-sm btn-danger" style="color:white"><?php echo getPhrase('no_delivered');?></a>
					                        <?php endif;?>
					                        <?php if($query->num_rows() > 0):?>
				  		                        <a class="btn nc btn-rounded btn-sm btn-success" style="color:white"><?php echo getPhrase('submitted_for_review');?></a>
					                        <?php endif;?>
				                            </td>
			                            </tr>
			                            <tr>
    				                        <th><b><?php echo getPhrase('mark');?></b>:</th>
				                            <td>
				                            <?php if($query->num_rows() <= 0):?>
