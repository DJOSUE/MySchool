    ...
    <div class="conty">
        ...
        <div class="cursos cta-with-media" style="background: #<?php echo $rows['color'];?>;">
            <div class="cta-content">
                ...
                <h3 class="cta-header"><?php echo $rows['name'];?> - <small><?php echo getPhrase('forum');?></small>
                </h3>
                <small
        ...
        <div class="os-tabs-w menu-shad">
            <div class="os-tabs-controls">
                <ul class="navs navs-tabs upper">
                    ...
                    <li class="navs-item">
                        <a class="navs-links active" href="<?php echo base_url();?>student/forum/<?php echo $data;?>/"><i
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a class="btn nc btn-rounded btn-sm btn-success"
                                                            style="color:white"><?php echo $row['timestamp'];?></a></td>
                                                    <td class="row-actions">
                                                        <a class="btn btn-rounded btn-sm btn-primary"
                                                            style="color:white"
                                                            href="<?php echo base_url();?>student/forumroom/<?php echo $row['post_code']; ?>"><i
                                                                class="picons-thin-icon-thin-0043_eye_visibility_show_visible"></i>
                                                            <?php echo getPhrase('view_forum');?></a>
                                                    </td>
                                                </tr>
                                                <?php endforeach;?>
                                            </tbody>
