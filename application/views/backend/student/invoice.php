            ...
            <div class="content-i">
                <div class="content-box">
                    <div class="element-wrapper">
                        <h6 class="element-header"><?php echo getPhrase('payments');?></h6>
                                ...
                                <table class="table table-padded">
                                    <thead>
                                        <tr>
				                            ...
				                            <th class="text-center"><?php echo getPhrase('amount');?></th>
				                            <th class="text-center"><?php echo getPhrase('status');?></th>
				                            <th><?php echo getPhrase('date');?></th>
				                            <th><?php echo getPhrase('invoice');?></th>
				                            <th><?php echo getPhrase('make_payment');?></th>
			                            </tr>
                                    </thead>
                                    <tbody>
				                        ...
				                        <tr>
					                        ...
					                        <td class="text-center"><?php if($row['status'] == 'completed'):?>
						                        <div class="status-pill green" data-title="<?php echo getPhrase('paid');?>" data-toggle="tooltip"></div>
					                            <?php endif;?>
					                            <?php if($row['status'] == 'pending'):?>
						                        <div class="status-pill red" data-title="<?php echo getPhrase('pending');?>" data-toggle="tooltip"></div>
					                            <?php endif;?>
					                        </td> 
					                        <td><a class="btn nc btn-rounded btn-sm btn-secondary" style="color:white"><?php echo $row['creation_timestamp'];?></a></td>
					                        <td><a class="btn btn-rounded btn-primary" style="color:white" href="<?php echo base_url();?>student/view_invoice/<?php echo $row['invoice_id'];?>"><i class="picons-thin-icon-thin-0406_money_dollar_euro_currency_exchange_cash"></i> <?php echo getPhrase('invoice');?></a></td>
					                        <td>
					                            <?php echo form_open(base_url() . 'student/invoice/make_payment', array('enctype' => 'multipart/form-data'));?>					
                                                    ...
                                                    <button type="submit" class="btn btn-rounded btn-success" <?php if($row['status'] == 'completed'):?> disabled="disabled"<?php endif;?>>
                                                        <i class="picons-thin-icon-thin-0424_money_payment_dollar_cash"></i> <?php echo getPhrase('pay_with_paypal');?>
                                                    </button>
                                                <?php echo form_close();?>
                                            </td>
				                        </tr>
