                        ...
                        <div class="rcard-table table-responsive">
                            <table class="table">
                                ...
                                <tbody>
                                    <?php 
                                        ...
                                        foreach ($tests as $item):
                                            ...
                                            else
                                            {
                                                ...
                                                $average = round((array_sum($score_array)/count($score_array)));
                                            }
                                    ...
                                    <?php endforeach;?>
                                    <tr class="text-center table-font-print<?php 
        ...
        <div class="element-wrapper">
            <div class="rcard-wy" id="print_area">
                <div class="rcard-w">
                    ...
                    <div class="rcard-heading div-center top-10">
                        <div id="chart_div"></div>
                    </div>
                    <div class="rcard-body div-center text-center">
                        <div class="round-corners">
                            <h7>AVERAGE SCORE %</h7>
                            <h6><?=round($average*100, 2);?></h6>
                        </div>
                    </div>
                    <div class="rcard-body div-center top-10 text-center">
                        <table class="table width-500 table-percentage">
                            <thead>
                                <tr>
