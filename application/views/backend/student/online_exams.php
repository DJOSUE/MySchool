                                        ...
                                        <table class="table table-padded">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo '<b>'.getPhrase('date').':</b> '.date('M d, Y', $row['exam_date']).'<br>'.'<b>'.getPhrase('hour').':</b> '.$row['time_start'].' - '.$row['time_end'];?>
                                                    </td>
                                                    <td class="bolder">
                                                        ...
                                                        <a href="<?php echo base_url();?>student/examroom/<?php echo $row['code'];?>/"
                                                            class="btn btn-success btn-rounded"><?php echo getPhrase('take_exam');?></a>
                                                        <?php else: ?>
                                                        <div class="btn btn-info btn-rounded">
                                                            <?php echo getPhrase('take_exam_message');?>
                                                        </div>
                                                        <?php endif; ?>
                                                        <?php else: ?>
                                                        <?php if($row['results'] == 0 || $row['results'] == 1):?>
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-success btn-rounded"><?php echo getPhrase('ask_for_results');?></a>
                                                        <?php elseif($row['results'] == 2):?>
                                                        <a href="<?php echo base_url();?>student/online_exam_result/<?php echo $row['online_exam_id'];?>/"
                                                            class="btn btn-success btn-rounded"><?php echo getPhrase('view_results');?></a>
                                                        <?php elseif($current_time > $exam_end_time && $current_time > $exam_end_time_results):?>
                                                        <a href="<?php echo base_url();?>student/online_exam_result/<?php echo $row['online_exam_id'];?>/"
                                                            class="btn btn-success btn-rounded"><?php echo getPhrase('view_results');?></a>
                                                        <?php else:?>
                                                        <a href="javascript:void(0);"
                                                            class="btn btn-warning btn-roundend"><?php echo getPhrase('waiting_results');?></a>
                                                        <?php endif; ?>
                                                        <?php endif;?>
                                                    </td>
                                                </tr>
