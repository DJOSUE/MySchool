        ...
        <div class="os-tabs-w menu-shad">
            <div class="os-tabs-controls">
                <ul class="navs navs-tabs upper">
                    ...
                    <?php endif;?>
                    <li class="navs-item">
                        <a class="navs-links active" href="<?php echo base_url();?>student/subject_meet/<?php echo $data;?>/"><i
                        ...
                        <div id="newsfeed-items-grid">
                            <div class="element-wrapper">
                                <div class="element-box-tp">
                                    <h6 class="element-header"><?php echo getPhrase('live');?></h6>
                                        ...
                                        <table class="table table-padded">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class=" bolder">
                                                        <a target="_blank"
                                                            href="<?php echo base_url();?>student/liveClass/<?php echo base64_encode($row['live_id']);?>/<?php echo $row['liveType'];?>"
