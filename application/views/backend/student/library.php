                    ...
                    <div class="os-tabs-controls">
                        <ul class="navs navs-tabs upper" style="padding-left:20px; padding-top:20px">
                            <li class="navs-item" style="display:inline;">
                                <a class="navs-link active" style="color:#000;" data-toggle="tab" href="#all"><?php echo getPhrase('library');?></a>
                            </li>
                            <li class="navs-item">
                                <a class="navs-link" style="color:#000;" data-toggle="tab" href="#request"><?php echo getPhrase('book_request');?></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="ui-block-title" style="background-color:#00579c">
                        <h6 class="title" style="color:white"><?php echo getPhrase('new_request');?></h6>
                    </div>
	                        ...
	                        <div class="row">
            		            ...
            		            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
	                	            <div class="form-group label-floating">
                  			            <label class="control-label"><?php echo getPhrase('starting_date');?></label>
            		            ...
            		            <div class="col col-lg-12 col-md-12 col-sm-12 col-12">
	                	            <div class="form-group label-floating">
                  			            <label class="control-label"><?php echo getPhrase('ending_date');?></label>
          		            ...
          		            <div class="form-buttons-w text-right">
	             	            <center><button class="btn btn-rounded btn-success" type="submit"><?php echo getPhrase('request');?></button></center>
          		            </div>
          	            <?php echo form_close();?>        
                    </div>
                </div>
