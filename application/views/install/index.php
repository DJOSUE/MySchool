...
<head>
    <title>Welcome to the installation wizard | MySchool</title>
    <meta charset="utf-8">
...
<body class="auth-wrapper login"
    style="background: url('public/uploads/bglogin.jpg');background-size: cover;background-repeat: no-repeat;">
    <div class="auth-box-w wider">
        <div class="logo-wy">
            <a href="<?php echo base_url();?>"><img alt="" src="https://guateapps.app/assets/front/image/png/logo.gif"
                    width="35%"></a>
        </div>
        <form class="form-horizontal form-groups" method="post"
            action="<?php echo base_url();?>index.php/install/setup">
            <div class="steps-w">
                <div class="step-triggers">
                    <a class="step-trigger active" href="#stepContent1">First</a><a class="step-trigger"
                        href="#stepContent2">Second</a><a class="step-trigger" href="#stepContent3">Third</a>
                </div>
                <div class="step-contents">
                    <div class="step-content active" id="stepContent1">
                        <div class="row">
                            <h5 class="form-header">Welcome to MySchool Installation Wizard!</h5>
                            <h4>Thanks for buying MySchool</h4>
                            <?php
                    session_start();
                    if($_SESSION['error'] == '1'):?>
                            <div class="alert alert-danger">An error occurred during the installation, verify that the
                                credentials of your database and purchase data are correct</div>
                            <?php endif;?>
                            <p>
                                We are sure that we will be the tool to help you improve your school's processes. <br>
                                <br> Before starting the installation process, please verify that you fulfill all the
                                following conditions . <b> All are required</b>
                            </p>
                                ...
                                <table class="table table-lightbor table-lightfont">
                                    <tr>
                                        <td>
                                            ...
                                            <strong> Required:</strong> <span style="color:green">-
                                                application/config/database.php to be writtable</span> <i
                                                class="picons-thin-icon-thin-0154_ok_successful_check"
                                                style="vertical-align:middle;font-size:18px;color:green"></i>
                                            <?php else:?>
                                            <strong> Required:</strong> <span style="color:red">-
                                                application/config/database.php to be writtable</span> <i
                                                class="picons-thin-icon-thin-0153_delete_exit_remove_close"
                                                style="vertical-align:middle;font-size:18px;color:red"></i>
                                            <?php endif;?>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            ...
                                            <strong> Required:</strong> <span style="color:green">-
                                                application/config/routes.php to be writtable</span> <i
                                                class="picons-thin-icon-thin-0154_ok_successful_check"
                                                style="vertical-align:middle;font-size:18px;color:green"></i>
                                            <?php else:?>
                                            <strong> Required:</strong> <span style="color:red">-
                                    ...
                                    <tr>
                                      ...
                                      if (in_array  ('curl', get_loaded_extensions())):?>
                                            <strong> Required:</strong> <span style="color:green">- php CURL function
                                                enabled</span> <i class="picons-thin-icon-thin-0154_ok_successful_check"
                                                style="vertical-align:middle;font-size:18px;color:green"></i>
                                            <?php else:?>
                                            <strong> Required:</strong> <span style="color:red">- php CURL function
                                                enabled</span> <i
                                                class="picons-thin-icon-thin-0153_delete_exit_remove_close"
                                                style="vertical-align:middle;font-size:18px;color:red"></i>
                                            <?php endif;?>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Codecanyon Username" required=""
                                        name="code_username" type="text">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="">Purchase Code*</label>
                                    <input class="form-control" placeholder="Purchase Code" name="purchase_code"
                    ...
                    <div class="step-content" id="stepContent2">
                        <div class="row">
                            ...
                            <p>You must create your database with your hosting provider, if you have doubts you can
                                request this data to the support of your hosting.
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for=""> Database Name*</label>
                                    <input class="form-control" name="database" required placeholder="Database Name"
                                        type="text">
                                </div>
                            </div>
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" required placeholder="Database Username"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" placeholder="Database Password" name="dbpassword"
                                        type="password">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" placeholder="My School" name="system_name" required
                                        type="text">
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input class="form-control" placeholder="My cool School App" name="system_title"
                                        required type="text">
                                </div>
                            </div>
                            <div class="form-group col-sm-6">
                            ...
                            ?>
                                        <option value="<?php echo $zone;?>">
                                            <?php echo 'UTC/GMT ' . date('P', $timestamp) .' - ' . $zone; ?></option>
                                        <?php } ?>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" required placeholder="Admin Username" name="admin"
                                        type="text">
                                </div>
                            </div>
                            <div class="col-sm-6">
